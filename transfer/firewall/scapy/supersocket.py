...
from scapy.compat import Any, Iterator, List, Optional, Tuple, Type, cast, _Generic_metaclass
    ...
    if six.PY2 or WINDOWS:
        ...
        def _recv_raw(self, sock, x):
            ...
            for cmsg_lvl, cmsg_type, cmsg_data in ancdata:
                ...
                elif cmsg_lvl == socket.SOL_SOCKET and cmsg_type == SO_TIMESTAMPNS:
    ...
    class L3RawSocket(SuperSocket):
        ...
        def send(self, x):
            ...
            try:
                ...
                raise ValueError("Missing 'dst' attribute in the first layer to be " 'sent using a native L3 socket ! (make sure you passed the ' 'IP layer)')

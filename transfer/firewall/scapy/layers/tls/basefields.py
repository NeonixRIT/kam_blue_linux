...
_tls_version = {0x0002: 'SSLv2', 0x0200: 'SSLv2', 0x0300: 'SSLv3', 0x0301: 'TLS 1.0', 0x0302: 'TLS 1.1', 0x0303: 'TLS 1.2', 0x7F12: 'TLS 1.3-d18', 0x7F13: 'TLS 1.3-d19', 0x0304: 'TLS 1.3'}

_tls_version_options = {'sslv2': 0x0002, 'sslv3': 0x0300, 'tls1': 0x0301, 'tls10': 0x0301, 'tls11': 0x0302, 'tls12': 0x0303, 'tls13-d18': 0x7F12, 'tls13-d19': 0x7F13, 'tls13': 0x0304}
...
class _TLSMACField(StrField):
    ...
    def getfield(self, pkt, s):
        if pkt.tls_session.rcs.cipher.type != 'aead' and False in six.itervalues(pkt.tls_session.rcs.cipher.ready):

...
class LDAP_BindRequest(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_CHOICE(
            ...
            ASN1F_PACKET('sasl', LDAP_SaslCredentials(), LDAP_SaslCredentials, implicit_tag=0xA3),
        ),
    )
...
class LDAP_BindResponse(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(*(LDAPResult.seq + (ASN1F_optional(ASN1F_STRING('serverSaslCreds', '', implicit_tag=0x87)),)))
...
class LDAP_SubstringFilterStr(ASN1_Packet):
    ...
    ASN1_root = ASN1F_CHOICE(
        'str',
        ASN1_STRING(''),
        ASN1F_PACKET('initial', LDAP_SubstringFilterInitial(), LDAP_SubstringFilterInitial, implicit_tag=0x0),
        ASN1F_PACKET('any', LDAP_SubstringFilterAny(), LDAP_SubstringFilterAny, implicit_tag=0x1),
        ASN1F_PACKET('final', LDAP_SubstringFilterFinal(), LDAP_SubstringFilterFinal, implicit_tag=0x2),
    )
...
class LDAP_Filter(ASN1_Packet):
    ...
    ASN1_root = ASN1F_CHOICE(
        'filter',
        LDAP_FilterPresent(),
        ASN1F_PACKET('and_', None, LDAP_FilterAnd, implicit_tag=0x80),
        ASN1F_PACKET('or_', None, LDAP_FilterOr, implicit_tag=0x81),
        ASN1F_PACKET('not_', None, _LDAP_Filter, implicit_tag=0x82),
        ASN1F_PACKET('equalityMatch', AttributeValueAssertion(), AttributeValueAssertion, implicit_tag=0x83),
        ASN1F_PACKET('substrings', LDAP_SubstringFilter(), LDAP_SubstringFilter, implicit_tag=0x84),
        ASN1F_PACKET('greaterOrEqual', AttributeValueAssertion(), AttributeValueAssertion, implicit_tag=0x85),
        ASN1F_PACKET('lessOrEqual', AttributeValueAssertion(), AttributeValueAssertion, implicit_tag=0x86),
        ASN1F_PACKET('present', LDAP_FilterPresent(), LDAP_FilterPresent, implicit_tag=0x87),
        ASN1F_PACKET('approxMatch', None, AttributeValueAssertion, implicit_tag=0x88),
    )
...
class LDAP_SearchRequest(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        LDAPDN('baseObject', ''),
        ASN1F_ENUMERATED('scope', 0, {0: 'baseObject', 1: 'singleLevel', 2: 'wholeSubtree'}),
        ASN1F_ENUMERATED('derefAliases', 0, {0: 'neverDerefAliases', 1: 'derefInSearching', 2: 'derefFindingBaseObj', 3: 'derefAlways'}),
...
class LDAP(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_CHOICE(
            'protocolOp',
            LDAP_SearchRequest(),
            ASN1F_PACKET('bindRequest', LDAP_BindRequest(), LDAP_BindRequest, implicit_tag=0x60),
            ASN1F_PACKET('bindResponse', LDAP_BindResponse(), LDAP_BindResponse, implicit_tag=0x61),
            ASN1F_PACKET('unbindRequest', LDAP_UnbindRequest(), LDAP_UnbindRequest, implicit_tag=0x42),
            ASN1F_PACKET('searchRequest', LDAP_SearchRequest(), LDAP_SearchRequest, implicit_tag=0x63),
            ASN1F_PACKET('searchResponse', LDAP_SearchResponseEntry(), LDAP_SearchResponseEntry, implicit_tag=0x64),
            ASN1F_PACKET('searchResponse', LDAP_SearchResponseResultCode(), LDAP_SearchResponseResultCode, implicit_tag=0x65),
            ASN1F_PACKET('abandonRequest', LDAP_AbandonRequest(), LDAP_AbandonRequest, implicit_tag=0x70),
        ),
        # LDAP v3 only
        ASN1F_optional(ASN1F_SEQUENCE_OF('Controls', [], LDAP_Control, implicit_tag=0x0)),
    )

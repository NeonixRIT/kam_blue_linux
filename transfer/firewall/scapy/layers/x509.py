...
from scapy.asn1.asn1 import ASN1_Codecs, ASN1_OID, ASN1_IA5_STRING, ASN1_NULL, ASN1_PRINTABLE_STRING, ASN1_UTC_TIME, ASN1_UTF8_STRING
...
class ASN1P_PRIVSEQ(ASN1_Packet):
    ...
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_IA5_STRING('str', ''), ASN1F_STRING('int', 0), explicit_tag=0, flexible_tag=True)
...
class RSAPublicKey(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_INTEGER('modulus', 10), ASN1F_INTEGER('publicExponent', 3))


class RSAOtherPrimeInfo(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_INTEGER('prime', 0), ASN1F_INTEGER('exponent', 0), ASN1F_INTEGER('coefficient', 0))
...
class ECFieldID(ASN1_Packet):
    ...
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('fieldType', 'prime-field'), ASN1F_INTEGER('prime', 0))


class ECCurve(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_STRING('a', ''), ASN1F_STRING('b', ''), ASN1F_optional(ASN1F_BIT_STRING('seed', None)))
...
class ECDSAPrivateKey(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_PACKET('parameters', None, ECParameters, explicit_tag=0xA0)),
        ASN1F_optional(ASN1F_PACKET('publicKey', None, ECDSAPublicKey, explicit_tag=0xA1)),
    )
...
class X509_AttributeValue(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('value', ASN1_PRINTABLE_STRING('FR'), ASN1F_PRINTABLE_STRING, ASN1F_UTF8_STRING, ASN1F_IA5_STRING, ASN1F_T61_STRING, ASN1F_UNIVERSAL_STRING)


class X509_Attribute(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('type', '2.5.4.6'), ASN1F_SET_OF('values', [X509_AttributeValue()], X509_AttributeValue))


class X509_AttributeTypeAndValue(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('type', '2.5.4.6'), ASN1F_X509_DirectoryString('value', ASN1_PRINTABLE_STRING('FR')))


class X509_RDN(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SET_OF('rdn', [X509_AttributeTypeAndValue()], X509_AttributeTypeAndValue)


class X509_OtherName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('type_id', '0'), ASN1F_CHOICE('value', None, ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING, explicit_tag=0xA0))
...
_default_directoryName = [
    X509_RDN(),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Name'))]),
]
...
class X509_EDIPartyName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_X509_DirectoryString('nameAssigner', None, explicit_tag=0xA0)), ASN1F_X509_DirectoryString('partyName', None, explicit_tag=0xA1))
...
class X509_ExtAuthorityKeyIdentifier(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_SEQUENCE_OF('authorityCertIssuer', None, X509_GeneralName, implicit_tag=0xA1)),
        ASN1F_optional(ASN1F_INTEGER('authorityCertSerialNumber', None, implicit_tag=0x82)),
    )


class X509_ExtSubjectDirectoryAttributes(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('subjectDirectoryAttributes', [X509_Attribute()], X509_Attribute)
...
class X509_ExtFullName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('fullName', [X509_GeneralName()], X509_GeneralName, implicit_tag=0xA0)


class X509_ExtNameRelativeToCRLIssuer(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_PACKET('nameRelativeToCRLIssuer', X509_RDN(), X509_RDN, implicit_tag=0xA1)


class X509_ExtDistributionPointName(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('distributionPointName', None, X509_ExtFullName, X509_ExtNameRelativeToCRLIssuer)


_reasons_mapping = ['unused', 'keyCompromise', 'cACompromise', 'affiliationChanged', 'superseded', 'cessationOfOperation', 'certificateHold', 'privilegeWithdrawn', 'aACompromise']


class X509_ExtDistributionPoint(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(
        ASN1F_optional(ASN1F_PACKET('distributionPoint', X509_ExtDistributionPointName(), X509_ExtDistributionPointName, explicit_tag=0xA0)),
        ASN1F_optional(ASN1F_FLAGS('reasons', None, _reasons_mapping, implicit_tag=0x81)),
        ASN1F_optional(ASN1F_SEQUENCE_OF('cRLIssuer', None, X509_GeneralName, implicit_tag=0xA2)),
    )


_ku_mapping = ['digitalSignature', 'nonRepudiation', 'keyEncipherment', 'dataEncipherment', 'keyAgreement', 'keyCertSign', 'cRLSign', 'encipherOnly', 'decipherOnly']
...
class X509_ExtPrivateKeyUsagePeriod(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_GENERALIZED_TIME('notBefore', str(GeneralizedTime(-600)), implicit_tag=0x80)), ASN1F_optional(ASN1F_GENERALIZED_TIME('notAfter', str(GeneralizedTime(+86400)), implicit_tag=0x81)))


class X509_PolicyMapping(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('issuerDomainPolicy', None), ASN1F_OID('subjectDomainPolicy', None))
...
class X509_ExtBasicConstraints(ASN1_Packet):
    ...
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_BOOLEAN('cA', False)), ASN1F_optional(ASN1F_INTEGER('pathLenConstraint', None)))
...
_cRL_reasons = ['unspecified', 'keyCompromise', 'cACompromise', 'affiliationChanged', 'superseded', 'cessationOfOperation', 'certificateHold', 'unused_reasonCode', 'removeFromCRL', 'privilegeWithdrawn', 'aACompromise']
...
class X509_ExtIssuingDistributionPoint(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_FLAGS('onlySomeReasons', None, _reasons_mapping, implicit_tag=0x83)),
...
class X509_ExtGeneralSubtree(ASN1_Packet):
    ...
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_PACKET('base', X509_GeneralName(), X509_GeneralName), ASN1F_optional(ASN1F_INTEGER('minimum', None, implicit_tag=0x80)), ASN1F_optional(ASN1F_INTEGER('maximum', None, implicit_tag=0x81)))


class X509_ExtNameConstraints(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_SEQUENCE_OF('permittedSubtrees', None, X509_ExtGeneralSubtree, implicit_tag=0xA0)), ASN1F_optional(ASN1F_SEQUENCE_OF('excludedSubtrees', None, X509_ExtGeneralSubtree, implicit_tag=0xA1)))


class X509_ExtPolicyConstraints(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_optional(ASN1F_INTEGER('requireExplicitPolicy', None, implicit_tag=0x80)), ASN1F_optional(ASN1F_INTEGER('inhibitPolicyMapping', None, implicit_tag=0x81)))
...
class X509_ExtNoticeReference(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_CHOICE('organization', ASN1_UTF8_STRING('Dummy Organization'), ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING), ASN1F_SEQUENCE_OF('noticeNumbers', [], ASN1P_INTEGER))
...
class X509_ExtUserNotice(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_CHOICE('explicitText', ASN1_UTF8_STRING('Dummy ExplicitText'), ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING)),
    )


class X509_ExtPolicyQualifierInfo(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('policyQualifierId', '1.3.6.1.5.5.7.2.1'), ASN1F_CHOICE('qualifier', ASN1_IA5_STRING('cps_str'), ASN1F_IA5_STRING, X509_ExtUserNotice))


class X509_ExtPolicyInformation(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('policyIdentifier', '2.5.29.32.0'), ASN1F_optional(ASN1F_SEQUENCE_OF('policyQualifiers', None, X509_ExtPolicyQualifierInfo)))


class X509_ExtCertificatePolicies(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('certificatePolicies', [X509_ExtPolicyInformation()], X509_ExtPolicyInformation)


class X509_ExtCRLDistributionPoints(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('cRLDistributionPoints', [X509_ExtDistributionPoint()], X509_ExtDistributionPoint)
...
class X509_AccessDescription(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('accessMethod', '0'), ASN1F_PACKET('accessLocation', X509_GeneralName(), X509_GeneralName))


class X509_ExtAuthInfoAccess(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('authorityInfoAccess', [X509_AccessDescription()], X509_AccessDescription)


class X509_ExtQcStatement(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('statementId', '0.4.0.1862.1.1'), ASN1F_optional(ASN1F_field('statementInfo', None)))


class X509_ExtQcStatements(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('qcStatements', [X509_ExtQcStatement()], X509_ExtQcStatement)


class X509_ExtSubjInfoAccess(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('subjectInfoAccess', [X509_AccessDescription()], X509_AccessDescription)
...
class X509_ExtComment(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('comment', ASN1_UTF8_STRING('Dummy comment.'), ASN1F_IA5_STRING, ASN1F_ISO646_STRING, ASN1F_BMP_STRING, ASN1F_UTF8_STRING)
...
class ASN1F_EXT_SEQUENCE(ASN1F_SEQUENCE):
    ...
    def __init__(self, **kargs):
        seq = [ASN1F_OID('extnID', '2.5.29.19'), ASN1F_optional(ASN1F_BOOLEAN('critical', False)), ASN1F_PACKET('extnValue', X509_ExtBasicConstraints(), X509_ExtBasicConstraints, explicit_tag=0x04)]
...
class X509_AlgorithmIdentifier(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('algorithm', '1.2.840.113549.1.1.11'), ASN1F_optional(ASN1F_CHOICE('parameters', ASN1_NULL(0), ASN1F_NULL, ECParameters)))
...
class RSAPrivateKey_OpenSSL(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_PACKET('privateKeyAlgorithm', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier),
...
class ECDSAPrivateKey_OpenSSL(Packet):
    ...
    fields_desc = [_PacketFieldRaw('ecparam', ECParameters(), ECParameters), PacketField('privateKey', ECDSAPrivateKey(), ECDSAPrivateKey)]
...
_default_issuer = [
    X509_RDN(),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Issuer'))]),
]

_default_subject = [
    X509_RDN(),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.10'), value=ASN1_PRINTABLE_STRING('Scapy, Inc.'))]),
    X509_RDN(rdn=[X509_AttributeTypeAndValue(type=ASN1_OID('2.5.4.3'), value=ASN1_PRINTABLE_STRING('Scapy Default Subject'))]),
]


class X509_Validity(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_CHOICE('not_before', ASN1_UTC_TIME(str(ZuluTime(-600))), ASN1F_UTC_TIME, ASN1F_GENERALIZED_TIME), ASN1F_CHOICE('not_after', ASN1_UTC_TIME(str(ZuluTime(+86400))), ASN1F_UTC_TIME, ASN1F_GENERALIZED_TIME))


_attrName_mapping = [('countryName', 'C'), ('stateOrProvinceName', 'ST'), ('localityName', 'L'), ('organizationName', 'O'), ('organizationUnitName', 'OU'), ('commonName', 'CN')]
...
class X509_TBSCertificate(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(
        ASN1F_optional(ASN1F_enum_INTEGER('version', 0x2, ['v1', 'v2', 'v3'], explicit_tag=0xA0)),
        ...
        ASN1F_PACKET('subjectPublicKeyInfo', X509_SubjectPublicKeyInfo(), X509_SubjectPublicKeyInfo),
        ...
        ASN1F_optional(ASN1F_SEQUENCE_OF('extensions', [X509_Extension()], X509_Extension, explicit_tag=0xA3)),
    )
...
class ASN1F_X509_CertECDSA(ASN1F_SEQUENCE):
    def __init__(self, **kargs):
        seq = [
            ...
            ASN1F_BIT_STRING_ENCAPS('signatureValue', ECDSASignature(), ECDSASignature),
        ]
        ASN1F_SEQUENCE.__init__(self, *seq, **kargs)
...
class X509_RevokedCertificate(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_INTEGER('serialNumber', 1), ASN1F_UTC_TIME('revocationDate', str(ZuluTime(+86400))), ASN1F_optional(ASN1F_SEQUENCE_OF('crlEntryExtensions', None, X509_Extension)))
...
class X509_TBSCertList(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_SEQUENCE_OF('revokedCertificates', None, X509_RevokedCertificate)),
        ASN1F_optional(ASN1F_SEQUENCE_OF('crlExtensions', None, X509_Extension, explicit_tag=0xA0)),
    )
...
class OCSP_CertID(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_PACKET('hashAlgorithm', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier), ASN1F_STRING('issuerNameHash', ''), ASN1F_STRING('issuerKeyHash', ''), ASN1F_INTEGER('serialNumber', 0))
...
class OCSP_RevokedInfo(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_GENERALIZED_TIME('revocationTime', ''), ASN1F_optional(ASN1F_PACKET('revocationReason', None, X509_ExtReasonCode, explicit_tag=0x80)))
...
class OCSP_CertStatus(ASN1_Packet):
    ...
    ASN1_root = ASN1F_CHOICE(
        ...
        ASN1F_PACKET('revoked', OCSP_RevokedInfo(), OCSP_RevokedInfo, implicit_tag=0xA1),
        ASN1F_PACKET('unknown', OCSP_UnknownInfo(), OCSP_UnknownInfo, implicit_tag=0x82),
    )
...
class OCSP_SingleResponse(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_SEQUENCE_OF('singleExtensions', None, X509_Extension, explicit_tag=0xA1)),
    )
...
class OCSP_ResponderID(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_CHOICE('responderID', None, ASN1F_PACKET('byName', OCSP_ByName(), OCSP_ByName, explicit_tag=0xA1), ASN1F_PACKET('byKey', OCSP_ByKey(), OCSP_ByKey, explicit_tag=0xA2))
...
class OCSP_ResponseData(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_SEQUENCE_OF('responseExtensions', None, X509_Extension, explicit_tag=0xA1)),
    )
...
class ASN1F_OCSP_BasicResponseECDSA(ASN1F_SEQUENCE):
    def __init__(self, **kargs):
        seq = [
            ...
            ASN1F_PACKET('signatureAlgorithm', X509_AlgorithmIdentifier(), X509_AlgorithmIdentifier),
            ASN1F_BIT_STRING_ENCAPS('signature', ECDSASignature(), ECDSASignature),
            ASN1F_optional(ASN1F_SEQUENCE_OF('certs', None, X509_Cert, explicit_tag=0xA0)),
        ]
        ASN1F_SEQUENCE.__init__(self, *seq, **kargs)
...
class OCSP_ResponseBytes(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('responseType', '1.3.6.1.5.5.7.48.1.1'), ASN1F_OCSP_BasicResponse(explicit_tag=0x04))


_responseStatus_mapping = ['successful', 'malformedRequest', 'internalError', 'tryLater', 'notUsed', 'sigRequired', 'unauthorized']


class OCSP_Response(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(ASN1F_ENUMERATED('responseStatus', 0, _responseStatus_mapping), ASN1F_optional(ASN1F_PACKET('responseBytes', None, OCSP_ResponseBytes, explicit_tag=0xA0)))

...
class PPPoE(Packet):
    ...
    fields_desc = [BitField('version', 1, 4), BitField('type', 1, 4), ByteEnumField('code', 0, {0: 'Session'}), XShortField('sessionid', 0x0), ShortField('len', None)]
...
class PPPoED(PPPoE):
    ...
    fields_desc = [BitField('version', 1, 4), BitField('type', 1, 4), ByteEnumField('code', 0x09, code_list), XShortField('sessionid', 0x0), ShortField('len', None)]
...
class HDLC(Packet):
    fields_desc = [XByteField('address', 0xFF), XByteField('control', 0x03)]
...
class PPP_IPCP_Option(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField('len', None, length_of='data', fmt='B', adjust=lambda _, val: val + 2),
...
class PPP_IPCP(Packet):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='options', adjust=lambda _, val: val + 4),
        PacketListField('options', [], PPP_IPCP_Option, length_from=lambda pkt: pkt.len - 4),
    ]
...
class PPP_ECP_Option_OUI(PPP_ECP_Option):
    fields_desc = [
        ...
        FieldLenField('len', None, length_of='data', fmt='B', adjust=lambda _, val: val + 6),
        OUIField('oui', 0),
        ByteField('subtype', 0),
...
class PPP_ECP(Packet):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='options', adjust=lambda _, val: val + 4),
        PacketListField('options', [], PPP_ECP_Option, length_from=lambda pkt: pkt.len - 4),
    ]
...
class PPP_LCP(Packet):
    ...
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='data', adjust=lambda _, val: val + 4),
...
class PPP_LCP_Option(Packet):
    ...
    fields_desc = [
        ...
        FieldLenField('len', None, fmt='B', length_of='data', adjust=lambda _, val: val + 2),
...
class PPP_LCP_Auth_Protocol_Option(PPP_LCP_Option):
    fields_desc = [
        ...
        FieldLenField('len', None, fmt='B', length_of='data', adjust=adjust_auth_len),
        ShortEnumField('auth_protocol', 0xC023, _PPP_LCP_auth_protocols),
        ConditionalField(StrLenField('data', '', length_from=lambda pkt: pkt.len - 4), lambda pkt: pkt.auth_protocol != 0xC223),
        ConditionalField(ByteEnumField('algorithm', 5, _PPP_LCP_CHAP_algorithms), lambda pkt: pkt.auth_protocol == 0xC223),
    ]
...
class PPP_LCP_Quality_Protocol_Option(PPP_LCP_Option):
    fields_desc = [
        ...
        FieldLenField('len', None, fmt='B', length_of='data', adjust=lambda _, val: val + 4),
...
class PPP_LCP_Callback_Option(PPP_LCP_Option):
    fields_desc = [
        ...
        FieldLenField('len', None, fmt='B', length_of='message', adjust=lambda _, val: val + 3),
...
class PPP_LCP_Configure(PPP_LCP):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='options', adjust=lambda _, val: val + 4),
        PacketListField('options', [], PPP_LCP_Option, length_from=lambda pkt: pkt.len - 4),
    ]
...
class PPP_LCP_Code_Reject(PPP_LCP):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='rejected_packet', adjust=lambda _, val: val + 4),
...
class PPP_LCP_Protocol_Reject(PPP_LCP):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='rejected_information', adjust=lambda _, val: val + 6),
...
class PPP_LCP_Discard_Request(PPP_LCP):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='H', length_of='data', adjust=lambda _, val: val + 8),
        IntField('magic_number', None),
...
class PPP_PAP_Request(PPP_PAP):
    fields_desc = [
        ByteEnumField('code', 1, _PPP_paptypes),
        XByteField('id', 0),
        FieldLenField('len', None, fmt='!H', length_of='username', adjust=lambda pkt, val: val + 6 + len(pkt.password)),
        FieldLenField('username_len', None, fmt='B', length_of='username'),
        StrLenField('username', None, length_from=lambda pkt: pkt.username_len),
...
class PPP_PAP_Response(PPP_PAP):
    fields_desc = [
        ...
        XByteField('id', 0),
        FieldLenField('len', None, fmt='!H', length_of='message', adjust=lambda _, val: val + 5),
...
class PPP_CHAP_ChallengeResponse(PPP_CHAP):
    fields_desc = [
        ...
        XStrLenField('value', b'\x00\x00\x00\x00\x00\x00\x00\x00', length_from=lambda pkt: pkt.value_size),
        StrLenField('optional_name', '', length_from=lambda pkt: pkt.len - pkt.value_size - 5),
    ]

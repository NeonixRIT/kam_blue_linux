...
from scapy.fields import ByteEnumField, ByteField, IntField, PacketField, ShortField, StrField, XIntField, XStrField, XStrLenField
...
class CryptAlgo(object):
    ...
    def __init__(self, name, cipher, mode, block_size=None, iv_size=None, key_size=None, icv_size=None, salt_size=None, format_mode_iv=None):  # noqa: E501
        """
...
if algorithms:
    ...
    CRYPT_ALGOS['CHACHA20-POLY1305'] = CryptAlgo('CHACHA20-POLY1305', cipher=aead.ChaCha20Poly1305, mode=None, key_size=32, block_size=1, iv_size=8, salt_size=4, icv_size=16, format_mode_iv=_salt_format_mode_iv)  # noqa: E501

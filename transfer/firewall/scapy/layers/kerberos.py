...
HostAddresses = lambda name, **kwargs: ASN1F_SEQUENCE_OF(name, [], HostAddress, **kwargs)
...
class AuthorizationData(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('seq', [AuthorizationDataItem()], AuthorizationDataItem)
...
class PA_AUTHENTICATION_SET(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE_OF('elems', [PA_AUTHENTICATION_SET_ELEM()], PA_AUTHENTICATION_SET_ELEM)
...
class KrbFastArmor(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SEQUENCE(
        ASN1F_enum_INTEGER('armorType', 1, {1: 'FX_FAST_ARMOR_AP_REQUEST'}, explicit_tag=0xA0),
...
class KrbFastArmoredReq(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ASN1F_SEQUENCE(
            ASN1F_optional(ASN1F_PACKET('armor', KrbFastArmor(), KrbFastArmor, explicit_tag=0xA0)),
...
class KrbFastResponse(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(ASN1F_PACKET('stengthenKey', None, EncryptionKey, explicit_tag=0xA1)),
        ASN1F_optional(ASN1F_PACKET('finished', KrbFastFinished(), KrbFastFinished, explicit_tag=0xA2)),
...
class EncTicketPart(ASN1_Packet):
    ...
    ASN1_root = ASN1F_KRB_APPLICATION(
        ASN1F_SEQUENCE(
            ...
            Realm('crealm', '', explicit_tag=0xA2),
            ASN1F_PACKET('cname', None, PrincipalName, explicit_tag=0xA3),
            ASN1F_PACKET('transited', TransitedEncoding(), TransitedEncoding, explicit_tag=0xA4),
            KerberosTime('authtime', GeneralizedTime(), explicit_tag=0xA5),
            ASN1F_optional(KerberosTime('starttime', GeneralizedTime(), explicit_tag=0xA6)),
            ...
            ASN1F_optional(
                ASN1F_PACKET('authorizationData', None, AuthorizationData, explicit_tag=0xAA),
            ),
        ),
        implicit_tag=3,
    )
...
class KRB_KDC_REQ_BODY(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_optional(
            ASN1F_PACKET('encAuthorizationData', None, EncryptedData, explicit_tag=0xAA),
        ),
        ASN1F_optional(ASN1F_SEQUENCE_OF('additionalTickets', [], KRB_Ticket, explicit_tag=0xAB)),
    )
...
class KRB_Authenticator(ASN1_Packet):
    ...
    ASN1_root = ASN1F_KRB_APPLICATION(
        ASN1F_SEQUENCE(
            ...
            ASN1F_optional(
                ASN1F_PACKET('encAuthorizationData', None, AuthorizationData, explicit_tag=0xA8),
            ),
        ),
        implicit_tag=2,
    )

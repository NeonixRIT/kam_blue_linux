...
from scapy.fields import ByteEnumField, ByteField, FieldLenField, FlagsField, IntEnumField, IntField, PacketLenField, ShortEnumField, ShortField, StrFixedLenField, StrLenField, XByteField
...
ISAKMPAttributeTypes = {
    ...
    'Authentication': (
        3,
        {
            ...
            'XAUTHRespRSARevisedEncryptio': 65010,
        },
        0,
    ),  # noqa: E501
    'GroupDesc': (
    ...
    'GroupType': (5, {'MODP': 1, 'ECP': 2, 'EC2N': 3}, 0),
    'GroupPrime': (6, {}, 1),
    'GroupGenerator1': (7, {}, 1),
    'GroupGenerator2': (8, {}, 1),
    'GroupCurveA': (9, {}, 1),
    'GroupCurveB': (10, {}, 1),
    'LifeType': (11, {'Seconds': 1, 'Kilobytes': 2}, 0),
    'LifeDuration': (12, {}, 1),
    'PRF': (13, {}, 0),
    'KeyLength': (14, {}, 0),
    'FieldSize': (15, {}, 0),
...
ISAKMP_payload_type = ['None', 'SA', 'Proposal', 'Transform', 'KE', 'ID', 'CERT', 'CR', 'Hash', 'SIG', 'Nonce', 'Notification', 'Delete', 'VendorID']

ISAKMP_exchange_type = ['None', 'base', 'identity prot.', 'auth only', 'aggressive', 'info']

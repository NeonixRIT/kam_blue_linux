...
class BTLE(Packet):
    name = 'BT4LE'
    fields_desc = [XLEIntField('access_addr', 0x8E89BED6), X3BytesField('crc', None)]
...
class BTLE_ADV(Packet):
    ...
    fields_desc = [
        ...
        BitEnumField('PDU_type', 0, 4, {0: 'ADV_IND', 1: 'ADV_DIRECT_IND', 2: 'ADV_NONCONN_IND', 3: 'SCAN_REQ', 4: 'SCAN_RSP', 5: 'CONNECT_REQ', 6: 'ADV_SCAN_IND'}),
...
BTLE_Corp_IDs = {0xF: 'Broadcom Corporation', 0x59: 'Nordic Semiconductor ASA'}

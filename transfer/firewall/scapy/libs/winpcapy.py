...
if BSD:
    ...
    class sockaddr(Structure):
        _fields_ = [('sa_len', c_ubyte), ('sa_family', c_ubyte), ('sa_data', c_ubyte * 14)]

    class sockaddr_in(Structure):
        _fields_ = [('sin_len', c_ubyte), ('sin_family', c_ubyte), ('sin_port', c_uint16), ('sin_addr', 4 * c_ubyte), ('sin_zero', 8 * c_char)]

    class sockaddr_in6(Structure):
        _fields_ = [('sin6_len', c_ubyte), ('sin6_family', c_ubyte), ('sin6_port', c_uint16), ('sin6_flowinfo', c_uint32), ('sin6_addr', 16 * c_ubyte), ('sin6_scope', c_uint32)]

    class sockaddr_dl(Structure):
        _fields_ = [('sdl_len', c_ubyte), ('sdl_family', c_ubyte), ('sdl_index', c_ushort), ('sdl_type', c_ubyte), ('sdl_nlen', c_ubyte), ('sdl_alen', c_ubyte), ('sdl_slen', c_ubyte), ('sdl_data', 46 * c_ubyte)]
    ...
    class sockaddr_in(Structure):
        _fields_ = [('sin_family', c_ushort), ('sin_port', c_uint16), ('sin_addr', 4 * c_ubyte)]

    class sockaddr_in6(Structure):
        _fields_ = [('sin6_family', c_ushort), ('sin6_port', c_uint16), ('sin6_flowinfo', c_uint32), ('sin6_addr', 16 * c_ubyte), ('sin6_scope', c_uint32)]
...
class pcap_file_header(Structure):
    _fields_ = [('magic', bpf_u_int32), ('version_major', u_short), ('version_minor', u_short), ('thiszone', bpf_int32), ('sigfigs', bpf_u_int32), ('snaplen', bpf_u_int32), ('linktype', bpf_u_int32)]
...
pcap_if._fields_ = [('next', POINTER(pcap_if)), ('name', STRING), ('description', STRING), ('addresses', POINTER(pcap_addr)), ('flags', bpf_u_int32)]

...
_mib_re_oiddecl = re.compile(r'$\s*([a-zA-Z0-9_-]+)\s+OBJECT[^:\{\}]+::=\s*\{([^\}]+)\}', re.M)
...
secsig_oids = {'1.3.14.3.2.26': 'sha1'}
...
certPkixQt_oids = {'1.3.6.1.5.5.7.2.1': 'cps', '1.3.6.1.5.5.7.2.2': 'unotice'}

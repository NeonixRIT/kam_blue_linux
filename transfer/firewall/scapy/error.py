...
class ScapyColoredFormatter(logging.Formatter):
    ...
    levels_colored = {'DEBUG': 'reset', 'INFO': 'reset', 'WARNING': 'bold+yellow', 'ERROR': 'bold+red', 'CRITICAL': 'bold+white+bg_red'}
    ...
    def format(self, record):
        ...
        message = conf.color_theme.format(message, self.levels_colored[record.levelname])
        return message

...
from scapy.layers.bluetooth import EIR_Hdr, EIR_ServiceData16BitUUID, EIR_CompleteList16BitServiceUUIDs, LowEnergyBeaconHelper
...
class Exposure_Notification_Frame(Packet, LowEnergyBeaconHelper):
    ...
    def build_eir(self):
        ...
        return LowEnergyBeaconHelper.base_eir + [EIR_Hdr() / EIR_CompleteList16BitServiceUUIDs(svc_uuids=[EXPOSURE_NOTIFICATION_UUID]), EIR_Hdr() / EIR_ServiceData16BitUUID() / self]


bind_layers(EIR_ServiceData16BitUUID, Exposure_Notification_Frame, svc_uuid=EXPOSURE_NOTIFICATION_UUID)

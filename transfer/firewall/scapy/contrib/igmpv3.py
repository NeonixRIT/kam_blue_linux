...
class IGMPv3(IGMP):
    ...
    name = 'IGMPv3'
    igmpv3types = {0x11: 'Membership Query', 0x22: 'Version 3 Membership Report', 0x30: 'Multicast Router Advertisement', 0x31: 'Multicast Router Solicitation', 0x32: 'Multicast Router Termination'}

    fields_desc = [ByteEnumField('type', 0x11, igmpv3types), ByteField('mrcode', 20), XShortField('chksum', None)]
...
class IGMPv3mr(Packet):
    ...
    name = 'IGMPv3mr'
    fields_desc = [XShortField('res2', 0), FieldLenField('numgrp', None, count_of='records'), PacketListField('records', [], IGMPv3gr, count_from=lambda x: x.numgrp)]  # noqa: E501
...
bind_layers(IP, IGMPv3, frag=0, proto=2, ttl=1, tos=0xC0, dst='224.0.0.22')

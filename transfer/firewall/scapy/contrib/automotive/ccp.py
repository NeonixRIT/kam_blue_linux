...
class CRO(Packet):
    ...
    fields_desc = [ByteEnumField('cmd', 0x01, commands), ByteField('ctr', 0)]
...
class DTO(Packet):
    ...
    fields_desc = [XByteField('packet_id', 0xFF), ByteEnumField('return_code', 0x00, return_codes), ByteField('ctr', 0)]

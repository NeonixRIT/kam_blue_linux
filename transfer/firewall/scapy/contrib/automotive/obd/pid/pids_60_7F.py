...
class OBD_PID61(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0, unit='%', offset=-125.0)]
...
class OBD_PID63(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0, unit='Nm', fmt='H')]
...
class OBD_PID67(OBD_Packet):
    ...
    fields_desc = [BitField('reserved', 0, 6), BitField('sensor2_supported', 0, 1), BitField('sensor1_supported', 0, 1), ScalingField('sensor1', 0, unit='deg. C', offset=-40.0), ScalingField('sensor2', 0, unit='deg. C', offset=-40.0)]
...
class OBD_PID69(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_egr_a_duty_cycle', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('actual_egr_a_duty_cycle', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('egr_a_error', 0, scaling=100 / 128.0, unit='%', offset=-100),
        ScalingField('commanded_egr_b_duty_cycle', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('actual_egr_b_duty_cycle', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('egr_b_error', 0, scaling=100 / 128.0, unit='%', offset=-100),
    ]


class OBD_PID6A(OBD_Packet):
    name = 'PID_6A_CommandedDieselIntakeAirFlowControl' 'AndRelativeIntakeAirFlowPosition'
    fields_desc = [
        ...
        ScalingField('commanded_intake_air_flow_a_control', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('relative_intake_air_flow_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('commanded_intake_air_flow_b_control', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('relative_intake_air_flow_b_position', 0, scaling=100 / 255.0, unit='%'),
    ]
...
class OBD_PID6C(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_throttle_actuator_a_control', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('relative_throttle_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('commanded_throttle_actuator_b_control', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('relative_throttle_b_position', 0, scaling=100 / 255.0, unit='%'),
    ]
...
class OBD_PID6D(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_fuel_rail_pressure', 0, scaling=10, unit='kPa', fmt='H'),
        ScalingField('fuel_rail_pressure', 0, scaling=10, unit='kPa', fmt='H'),
...
class OBD_PID6E(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_injection_control_pressure', 0, scaling=10, unit='kPa', fmt='H'),
        ScalingField('injection_control_pressure', 0, scaling=10, unit='kPa', fmt='H'),
    ]
...
class OBD_PID70(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_boost_pressure_a', 0, scaling=0.03125, unit='kPa', fmt='H'),
        ScalingField('boost_pressure_sensor_a', 0, scaling=0.03125, unit='kPa', fmt='H'),
        ScalingField('commanded_boost_pressure_b', 0, scaling=0.03125, unit='kPa', fmt='H'),
        ScalingField('boost_pressure_sensor_b', 0, scaling=0.03125, unit='kPa', fmt='H'),
    ]
...
class OBD_PID71(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_variable_geometry_turbo_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('variable_geometry_turbo_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('commanded_variable_geometry_turbo_b_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('variable_geometry_turbo_b_position', 0, scaling=100 / 255.0, unit='%'),
    ]
...
class OBD_PID72(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('commanded_wastegate_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('wastegate_a_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('commanded_wastegate_b_position', 0, scaling=100 / 255.0, unit='%'),
        ScalingField('wastegate_b_position', 0, scaling=100 / 255.0, unit='%'),
    ]
...
class OBD_PID75(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('turbocharger_a_compressor_inlet_temperature', 0, unit='deg. C', offset=-40),
        ScalingField('turbocharger_a_compressor_outlet_temperature', 0, unit='deg. C', offset=-40),
        ScalingField('turbocharger_a_turbine_inlet_temperature', 0, unit='deg. C', offset=-40, fmt='H', scaling=0.1),
        ScalingField('turbocharger_a_turbine_outlet_temperature', 0, unit='deg. C', offset=-40, fmt='H', scaling=0.1),
    ]
...
class _OBD_PID_ExhaustGasTemperatureBank(OBD_Packet):
    fields_desc = [
        ...
        ScalingField('sensor1', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('sensor2', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('sensor3', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('sensor4', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
    ]
...
class _OBD_PID_DieselParticulateFilter(OBD_Packet):
    fields_desc = [
        ...
        ScalingField('delta_pressure', 0, unit='kPa', offset=-327.68, scaling=0.01, fmt='H'),
        ScalingField('particulate_filter', 0, unit='kPa', scaling=0.01, fmt='H'),
        ScalingField('outlet_pressure', 0, unit='kPa', scaling=0.01, fmt='H'),
    ]
...
class OBD_PID7C(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('bank1_inlet_temperature_sensor', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('bank1_outlet_temperature_sensor', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('bank2_inlet_temperature_sensor', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
        ScalingField('bank2_outlet_temperature_sensor', 0, unit='deg. C', offset=-40, scaling=0.1, fmt='H'),
    ]

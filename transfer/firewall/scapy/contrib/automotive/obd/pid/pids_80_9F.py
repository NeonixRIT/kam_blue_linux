...
class OBD_PID81(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('total_run_time_with_ei_aecd1', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd2', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd3', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd4', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd5', 0, unit='sec', fmt='Q'),
    ]
...
class OBD_PID82(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('total_run_time_with_ei_aecd6', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd7', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd8', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd9', 0, unit='sec', fmt='Q'),
        ScalingField('total_run_time_with_ei_aecd10', 0, unit='sec', fmt='Q'),
    ]
...
class OBD_PID83(OBD_Packet):
    ...
    fields_desc = [
        ...
        ScalingField('nox_sensor_concentration_bank1_sensor1', 0, unit='ppm', fmt='H'),
        ScalingField('nox_sensor_concentration_bank2_sensor1', 0, unit='ppm', fmt='H'),
    ]


class OBD_PID84(OBD_Packet):
    name = 'PID_84_ManifoldSurfaceTemperature'
    fields_desc = [StrFixedLenField('data', b'', 1)]


class OBD_PID85(OBD_Packet):
    name = 'PID_85_NoxReagentSystem'
    fields_desc = [StrFixedLenField('data', b'', 10)]


class OBD_PID86(OBD_Packet):
    name = 'PID_86_ParticulateMatterSensor'
    fields_desc = [StrFixedLenField('data', b'', 5)]
...
class OBD_PID88(OBD_Packet):
    ...
    fields_desc = [StrFixedLenField('data', b'', 13)]


class OBD_PID89(OBD_Packet):
    # 11 - 15
    name = 'PID_89_RunTimeForAecd'
    fields_desc = [StrFixedLenField('data', b'', 41)]
...
class OBD_PID8B(OBD_Packet):
    ...
    fields_desc = [StrFixedLenField('data', b'', 7)]


class OBD_PID8C(OBD_Packet):
    name = 'PID_8C_O2Sensor'
    fields_desc = [StrFixedLenField('data', b'', 16)]
...
class OBD_PID90(OBD_Packet):
    ...
    fields_desc = [StrFixedLenField('data', b'', 3)]
...
class OBD_PID92(OBD_Packet):
    ...
    fields_desc = [StrFixedLenField('data', b'', 2)]
...
class OBD_PID94(OBD_Packet):
    ...
    fields_desc = [StrFixedLenField('data', b'', 12)]


class OBD_PID98(OBD_Packet):
    name = 'PID_98_ExhaustGasTemperatureSensor'
    fields_desc = [StrFixedLenField('data', b'', 9)]

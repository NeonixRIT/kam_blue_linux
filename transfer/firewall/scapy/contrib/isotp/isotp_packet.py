...
from scapy.fields import BitField, FlagsField, StrLenField, ThreeBytesField, XBitField, ConditionalField, BitEnumField, ByteField, XByteField, BitFieldLenField, StrField
...
class ISOTP_FF(Packet):
    ...
    fields_desc = [BitEnumField('type', 1, 4, ISOTP_TYPE), BitField('message_size', 0, 12), ConditionalField(BitField('extended_message_size', 0, 32), lambda pkt: pkt.message_size == 0), StrField('data', b'', fmt='B')]
...
class ISOTP_FC(Packet):
    ...
    fields_desc = [
        ...
        BitEnumField('fc_flag', 0, 4, {0: 'continue', 1: 'wait', 2: 'abort'}),

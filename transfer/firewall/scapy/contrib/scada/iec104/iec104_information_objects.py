...
from scapy.contrib.scada.iec104.iec104_information_elements import (
    ...
    IEC104_IE_NVA,
    IEC104_IE_SVA,
    IEC104_IE_R32_IEEE_STD_754,
    IEC104_IE_BCR,
    IEC104_IE_CP16TIME2A_ELAPSED,
    IEC104_IE_SEP,
    IEC104_IE_SPE,
    ...
    IEC104_IE_CP56TIME2A_STOP_TIME,
    IEC104_IE_TSC,
)
...
IEC104_IO_DESCRIPTIONS = {
    ...
    IEC104_IO_ID_M_SP_TA_1: 'M_SP_TA_1 (single point report with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_DP_NA_1: 'M_DP_NA_1 (double point report)',
    IEC104_IO_ID_M_DP_TA_1: 'M_DP_TA_1 (double point report with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_ST_NA_1: 'M_ST_NA_1 (step control report)',
    IEC104_IO_ID_M_ST_TA_1: 'M_ST_TA_1 (step control report with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_BO_NA_1: 'M_BO_NA_1 (bitmask 32 bit)',
    IEC104_IO_ID_M_BO_TA_1: 'M_BO_TA_1 (bitmask 32 bit with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_ME_NA_1: 'M_ME_NA_1 (meas, normed value)',
    IEC104_IO_ID_M_ME_TA_1: 'M_ME_TA_1 (meas, normed value with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_ME_NB_1: 'M_ME_NB_1 (meas, scaled value)',
    IEC104_IO_ID_M_ME_TB_1: 'M_ME_TB_1 (meas, scaled value with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_ME_NC_1: 'M_ME_NC_1 (meas, shortened floating point value)',
    IEC104_IO_ID_M_ME_TC_1: 'M_ME_TC_1 (meas, shortened floating point value ' 'with timestamp) # 60870-4-101 only',
    IEC104_IO_ID_M_IT_NA_1: 'M_IT_NA_1 (counter value)',
    IEC104_IO_ID_M_IT_TA_1: 'M_IT_TA_1 (counter value with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_EP_TA_1: 'M_EP_TA_1 (protection event  with timestamp) ' '# 60870-4-101 only',
    IEC104_IO_ID_M_EP_TB_1: 'M_EP_TB_1 (blocked protection trigger with ' 'timestamp) # 60870-4-101 only',
    IEC104_IO_ID_M_EP_TC_1: 'M_EP_TC_1 (blocked protection action with ' 'timestamp) # 60870-4-101 only',
    IEC104_IO_ID_M_PS_NA_1: 'M_PS_NA_1 (blocked single report with ' 'change indication)',
    IEC104_IO_ID_M_ME_ND_1: 'M_ME_ND_1 (meas, normed value, no quality ' 'indication)',
    IEC104_IO_ID_M_SP_TB_1: 'M_SP_TB_1 (single point report with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_DP_TB_1: 'M_DP_TB_1 (double point report with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_ST_TB_1: 'M_ST_TB_1 (step control report with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_BO_TB_1: 'M_BO_TB_1 (bitmask 32 bit with CP56Time2a time ' 'field)',
    IEC104_IO_ID_M_ME_TD_1: 'M_ME_TD_1 (meas, normed value with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_ME_TE_1: 'M_ME_TE_1 (meas, scaled value with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_ME_TF_1: 'M_ME_TF_1 (meas, shortened floating point value ' 'with CP56Time2a time field)',
    IEC104_IO_ID_M_IT_TB_1: 'M_IT_TB_1 (counter with CP56Time2a time field)',
    IEC104_IO_ID_M_EP_TD_1: 'M_EP_TD_1 (protection event with CP56Time2a ' 'time field)',
    IEC104_IO_ID_M_EP_TE_1: 'M_EP_TE_1 (blocked protection trigger with ' 'CP56Time2a time field)',
    IEC104_IO_ID_M_EP_TF_1: 'M_EP_TF_1 (blocked protection action with ' 'CP56Time2a time field)',
    ...
    IEC104_IO_ID_C_SE_NA_1: 'C_SE_NA_1 (setpoint control command, ' 'normed value)',
    IEC104_IO_ID_C_SE_NB_1: 'C_SE_NB_1 (setpoint control command, ' 'scaled value)',
    IEC104_IO_ID_C_SE_NC_1: 'C_SE_NC_1 (setpoint control command, ' 'shortened floating point value)',
    IEC104_IO_ID_C_BO_NA_1: 'C_BO_NA_1 (bitmask 32 bit)',
    IEC104_IO_ID_C_SC_TA_1: 'C_SC_TA_1 (single point command with ' 'CP56Time2a time field)',
    IEC104_IO_ID_C_DC_TA_1: 'C_DC_TA_1 (double point command with ' 'CP56Time2a time field)',
    IEC104_IO_ID_C_RC_TA_1: 'C_RC_TA_1 (step control command with ' 'CP56Time2a time field)',
    IEC104_IO_ID_C_SE_TA_1: 'C_SE_TA_1 (setpoint command, normed value with ' 'CP56Time2a time field)',
    IEC104_IO_ID_C_SE_TB_1: 'C_SE_TB_1 (setpoint command, scaled value with ' 'CP56Time2a time field)',
    IEC104_IO_ID_C_SE_TC_1: 'C_SE_TC_1 (setpoint command, shortened floating ' 'point value with CP56Time2a time field)',
    IEC104_IO_ID_C_BO_TA_1: 'C_BO_TA_1 (bitmask 32 command bit with ' 'CP56Time2a time field)',
    ...
    IEC104_IO_ID_C_CD_NA_1: 'C_CD_NA_1 (meas telegram transit time command) ' '# 60870-4-101 only',
    IEC104_IO_ID_C_TS_TA_1: 'C_TS_TA_1 (test command with CP56Time2a ' 'time field)',
    IEC104_IO_ID_P_ME_NA_1: 'P_ME_NA_1 (meas parameter, normed value)',
    IEC104_IO_ID_P_ME_NB_1: 'P_ME_NB_1 (meas parameter, scaled value)',
    IEC104_IO_ID_P_ME_NC_1: 'P_ME_NC_1 (meas parameter, shortened floating ' 'point value)',
...
class IEC104_IO_M_SP_NA_1(IEC104_IO_Packet):
    ...
    _DEFINED_IN = [IEC104_IO_Packet.DEFINED_IN_IEC_101, IEC104_IO_Packet.DEFINED_IN_IEC_104]
...
class IEC104_IO_M_SP_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SIQ.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_DP_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_DIQ.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_ST_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_VTI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_ST_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_VTI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_BO_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BSI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_BO_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BSI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_ME_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_NB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_ME_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_NC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_ME_TC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_IT_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BCR.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_EP_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SEP.informantion_element_fields + IEC104_IE_CP16TIME2A_ELAPSED.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_EP_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SPE.informantion_element_fields + IEC104_IE_QDP.informantion_element_fields + IEC104_IE_CP16TIME2A_PROTECTION_ACTIVE.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_EP_TC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_OCI.informantion_element_fields + IEC104_IE_QDP.informantion_element_fields + IEC104_IE_CP16TIME2A_PROTECTION_COMMAND.informantion_element_fields + IEC104_IE_CP24TIME2A.informantion_element_fields
...
class IEC104_IO_M_PS_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SCD.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields
...
class IEC104_IO_M_DP_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_DIQ.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_ST_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_VTI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_BO_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BSI.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_TD_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_TE_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_ME_TF_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QDS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_IT_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BCR.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_EP_TE_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SPE.informantion_element_fields + IEC104_IE_QDP.informantion_element_fields + IEC104_IE_CP16TIME2A_PROTECTION_ACTIVE.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_M_EP_TF_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_OCI.informantion_element_fields + IEC104_IE_QDP.informantion_element_fields + IEC104_IE_CP16TIME2A_PROTECTION_COMMAND.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_SE_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields
...
class IEC104_IO_C_SE_NB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields
...
class IEC104_IO_C_SE_NC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields
...
class IEC104_IO_P_ME_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QPM.informantion_element_fields
...
class IEC104_IO_P_ME_NB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QPM.informantion_element_fields
...
class IEC104_IO_P_ME_NC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QPM.informantion_element_fields
...
class IEC104_IO_F_FR_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_LOF.informantion_element_fields + IEC104_IE_FRQ.informantion_element_fields
...
class IEC104_IO_F_SR_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_NOS.informantion_element_fields + IEC104_IE_LOF.informantion_element_fields + IEC104_IE_SRQ.informantion_element_fields
...
class IEC104_IO_F_SC_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_NOS.informantion_element_fields + IEC104_IE_SCQ.informantion_element_fields
...
class IEC104_IO_F_LS_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_NOS.informantion_element_fields + IEC104_IE_LSQ.informantion_element_fields + IEC104_IE_CHS.informantion_element_fields
...
class IEC104_IO_F_AF_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_NOS.informantion_element_fields + IEC104_IE_AFQ.informantion_element_fields
...
class IEC104_IO_F_SG_NA_1(IEC104_IO_Packet):
    ...
    fields_desc = (
        IEC104_IE_NOF.informantion_element_fields
        + IEC104_IE_NOS.informantion_element_fields
        + [
            BitFieldLenField('segment_length', None, 8, length_of='data'),  # repr IEC104_IE_LOS
            XStrLenField('data', '', length_from=lambda pkt: pkt.segment_length),
        ]
    )
...
class IEC104_IO_F_DR_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_LOF.informantion_element_fields + IEC104_IE_SOF.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_SC_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SCO.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_DC_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_DCO.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_SE_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NVA.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_SE_TB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_SVA.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_SE_TC_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_R32_IEEE_STD_754.informantion_element_fields + IEC104_IE_QOS.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_BO_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_BSI.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_C_TS_TA_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_TSC.informantion_element_fields + IEC104_IE_CP56TIME2A.informantion_element_fields
...
class IEC104_IO_F_SC_NB_1(IEC104_IO_Packet):
    ...
    fields_desc = IEC104_IE_NOF.informantion_element_fields + IEC104_IE_CP56TIME2A_START_TIME.informantion_element_fields + IEC104_IE_CP56TIME2A_STOP_TIME.informantion_element_fields
...
class IEC104_IO_M_SP_NA_1_IOA(IEC104_IO_M_SP_NA_1):
    ...
    name = 'M_SP_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_SP_NA_1.fields_desc
...
class IEC104_IO_M_SP_TA_1_IOA(IEC104_IO_M_SP_TA_1):
    ...
    name = 'M_SP_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_SP_TA_1.fields_desc
...
class IEC104_IO_M_DP_NA_1_IOA(IEC104_IO_M_DP_NA_1):
    ...
    name = 'M_DP_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_DP_NA_1.fields_desc
...
class IEC104_IO_M_DP_TA_1_IOA(IEC104_IO_M_DP_TA_1):
    ...
    name = 'M_DP_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_DP_TA_1.fields_desc
...
class IEC104_IO_M_ST_NA_1_IOA(IEC104_IO_M_ST_NA_1):
    ...
    name = 'M_ST_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ST_NA_1.fields_desc
...
class IEC104_IO_M_ST_TA_1_IOA(IEC104_IO_M_ST_TA_1):
    ...
    name = 'M_ST_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ST_TA_1.fields_desc
...
class IEC104_IO_M_BO_NA_1_IOA(IEC104_IO_M_BO_NA_1):
    ...
    name = 'M_BO_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_BO_NA_1.fields_desc
...
class IEC104_IO_M_BO_TA_1_IOA(IEC104_IO_M_BO_TA_1):
    ...
    name = 'M_BO_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_BO_TA_1.fields_desc
...
class IEC104_IO_M_ME_NA_1_IOA(IEC104_IO_M_ME_NA_1):
    ...
    name = 'M_ME_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_NA_1.fields_desc
...
class IEC104_IO_M_ME_TA_1_IOA(IEC104_IO_M_ME_TA_1):
    ...
    name = 'M_ME_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TA_1.fields_desc
...
class IEC104_IO_M_ME_NB_1_IOA(IEC104_IO_M_ME_NB_1):
    ...
    name = 'M_ME_NB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_NB_1.fields_desc
...
class IEC104_IO_M_ME_TB_1_IOA(IEC104_IO_M_ME_TB_1):
    ...
    name = 'M_ME_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TB_1.fields_desc
...
class IEC104_IO_M_ME_NC_1_IOA(IEC104_IO_M_ME_NC_1):
    ...
    name = 'M_ME_NC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_NC_1.fields_desc
...
class IEC104_IO_M_ME_TC_1_IOA(IEC104_IO_M_ME_TC_1):
    ...
    name = 'M_ME_TC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TC_1.fields_desc
...
class IEC104_IO_M_IT_NA_1_IOA(IEC104_IO_M_IT_NA_1):
    ...
    name = 'M_IT_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_IT_NA_1.fields_desc
...
class IEC104_IO_M_IT_TA_1_IOA(IEC104_IO_M_IT_TA_1):
    ...
    name = 'M_IT_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_IT_TA_1.fields_desc
...
class IEC104_IO_M_EP_TA_1_IOA(IEC104_IO_M_EP_TA_1):
    ...
    name = 'M_EP_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TA_1.fields_desc
...
class IEC104_IO_M_EP_TB_1_IOA(IEC104_IO_M_EP_TB_1):
    ...
    name = 'M_EP_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TB_1.fields_desc
...
class IEC104_IO_M_EP_TC_1_IOA(IEC104_IO_M_EP_TC_1):
    ...
    name = 'M_EP_TC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TC_1.fields_desc
...
class IEC104_IO_M_PS_NA_1_IOA(IEC104_IO_M_PS_NA_1):
    ...
    name = 'M_PS_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_PS_NA_1.fields_desc
...
class IEC104_IO_M_ME_ND_1_IOA(IEC104_IO_M_ME_ND_1):
    ...
    name = 'M_ME_ND_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_ND_1.fields_desc
...
class IEC104_IO_M_SP_TB_1_IOA(IEC104_IO_M_SP_TB_1):
    ...
    name = 'M_SP_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_SP_TB_1.fields_desc
...
class IEC104_IO_M_DP_TB_1_IOA(IEC104_IO_M_DP_TB_1):
    ...
    name = 'M_DP_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_DP_TB_1.fields_desc
...
class IEC104_IO_M_ST_TB_1_IOA(IEC104_IO_M_ST_TB_1):
    ...
    name = 'M_ST_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ST_TB_1.fields_desc
...
class IEC104_IO_M_BO_TB_1_IOA(IEC104_IO_M_BO_TB_1):
    ...
    name = 'M_BO_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_BO_TB_1.fields_desc
...
class IEC104_IO_M_ME_TD_1_IOA(IEC104_IO_M_ME_TD_1):
    ...
    name = 'M_ME_TD_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TD_1.fields_desc
...
class IEC104_IO_M_ME_TE_1_IOA(IEC104_IO_M_ME_TE_1):
    ...
    name = 'M_ME_TE_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TE_1.fields_desc
...
class IEC104_IO_M_ME_TF_1_IOA(IEC104_IO_M_ME_TF_1):
    ...
    name = 'M_ME_TF_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_ME_TF_1.fields_desc
...
class IEC104_IO_M_IT_TB_1_IOA(IEC104_IO_M_IT_TB_1):
    ...
    name = 'M_IT_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_IT_TB_1.fields_desc
...
class IEC104_IO_M_EP_TD_1_IOA(IEC104_IO_M_EP_TD_1):
    ...
    name = 'M_EP_TD_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TD_1.fields_desc
...
class IEC104_IO_M_EP_TE_1_IOA(IEC104_IO_M_EP_TE_1):
    ...
    name = 'M_EP_TE_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TE_1.fields_desc
...
class IEC104_IO_M_EP_TF_1_IOA(IEC104_IO_M_EP_TF_1):
    ...
    name = 'M_EP_TF_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EP_TF_1.fields_desc
...
class IEC104_IO_C_SC_NA_1_IOA(IEC104_IO_C_SC_NA_1):
    ...
    name = 'C_SC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SC_NA_1.fields_desc
...
class IEC104_IO_C_DC_NA_1_IOA(IEC104_IO_C_DC_NA_1):
    ...
    name = 'C_DC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_DC_NA_1.fields_desc
...
class IEC104_IO_C_RC_NA_1_IOA(IEC104_IO_C_RC_NA_1):
    ...
    name = 'C_RC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_RC_NA_1.fields_desc
...
class IEC104_IO_C_SE_NA_1_IOA(IEC104_IO_C_SE_NA_1):
    ...
    name = 'C_SE_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_NA_1.fields_desc
...
class IEC104_IO_C_SE_NB_1_IOA(IEC104_IO_C_SE_NB_1):
    ...
    name = 'C_SE_NB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_NB_1.fields_desc
...
class IEC104_IO_C_SE_NC_1_IOA(IEC104_IO_C_SE_NC_1):
    ...
    name = 'C_SE_NC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_NC_1.fields_desc
...
class IEC104_IO_C_BO_NA_1_IOA(IEC104_IO_C_BO_NA_1):
    ...
    name = 'C_BO_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_BO_NA_1.fields_desc
...
class IEC104_IO_C_SC_TA_1_IOA(IEC104_IO_C_SC_TA_1):
    ...
    name = 'C_SC_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SC_TA_1.fields_desc
...
class IEC104_IO_C_DC_TA_1_IOA(IEC104_IO_C_DC_TA_1):
    ...
    name = 'C_DC_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_DC_TA_1.fields_desc
...
class IEC104_IO_C_RC_TA_1_IOA(IEC104_IO_C_RC_TA_1):
    ...
    name = 'C_RC_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_RC_TA_1.fields_desc
...
class IEC104_IO_C_SE_TA_1_IOA(IEC104_IO_C_SE_TA_1):
    ...
    name = 'C_SE_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_TA_1.fields_desc
...
class IEC104_IO_C_SE_TB_1_IOA(IEC104_IO_C_SE_TB_1):
    ...
    name = 'C_SE_TB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_TB_1.fields_desc
...
class IEC104_IO_C_SE_TC_1_IOA(IEC104_IO_C_SE_TC_1):
    ...
    name = 'C_SE_TC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_SE_TC_1.fields_desc
...
class IEC104_IO_C_BO_TA_1_IOA(IEC104_IO_C_BO_TA_1):
    ...
    name = 'C_BO_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_BO_TA_1.fields_desc
...
class IEC104_IO_M_EI_NA_1_IOA(IEC104_IO_M_EI_NA_1):
    ...
    name = 'M_EI_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_M_EI_NA_1.fields_desc
...
class IEC104_IO_C_IC_NA_1_IOA(IEC104_IO_C_IC_NA_1):
    ...
    name = 'C_IC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_IC_NA_1.fields_desc
...
class IEC104_IO_C_CI_NA_1_IOA(IEC104_IO_C_CI_NA_1):
    ...
    name = 'C_CI_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_CI_NA_1.fields_desc
...
class IEC104_IO_C_RD_NA_1_IOA(IEC104_IO_C_RD_NA_1):
    ...
    name = 'C_RD_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_RD_NA_1.fields_desc
...
class IEC104_IO_C_CS_NA_1_IOA(IEC104_IO_C_CS_NA_1):
    ...
    name = 'C_CS_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_CS_NA_1.fields_desc
...
class IEC104_IO_C_TS_NA_1_IOA(IEC104_IO_C_TS_NA_1):
    ...
    name = 'C_TS_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_TS_NA_1.fields_desc
...
class IEC104_IO_C_RP_NA_1_IOA(IEC104_IO_C_RP_NA_1):
    ...
    name = 'C_RP_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_RP_NA_1.fields_desc
...
class IEC104_IO_C_CD_NA_1_IOA(IEC104_IO_C_CD_NA_1):
    ...
    name = 'C_CD_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_CD_NA_1.fields_desc
...
class IEC104_IO_C_TS_TA_1_IOA(IEC104_IO_C_TS_TA_1):
    ...
    name = 'C_TS_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_C_TS_TA_1.fields_desc
...
class IEC104_IO_P_ME_NA_1_IOA(IEC104_IO_P_ME_NA_1):
    ...
    name = 'P_ME_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_P_ME_NA_1.fields_desc
...
class IEC104_IO_P_ME_NB_1_IOA(IEC104_IO_P_ME_NB_1):
    ...
    name = 'P_ME_NB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_P_ME_NB_1.fields_desc
...
class IEC104_IO_P_ME_NC_1_IOA(IEC104_IO_P_ME_NC_1):
    ...
    name = 'P_ME_NC_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_P_ME_NC_1.fields_desc
...
class IEC104_IO_P_AC_NA_1_IOA(IEC104_IO_P_AC_NA_1):
    ...
    name = 'P_AC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_P_AC_NA_1.fields_desc
...
class IEC104_IO_F_FR_NA_1_IOA(IEC104_IO_F_FR_NA_1):
    ...
    name = 'F_FR_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_FR_NA_1.fields_desc
...
class IEC104_IO_F_SR_NA_1_IOA(IEC104_IO_F_SR_NA_1):
    ...
    name = 'F_SR_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_SR_NA_1.fields_desc
...
class IEC104_IO_F_SC_NA_1_IOA(IEC104_IO_F_SC_NA_1):
    ...
    name = 'F_SC_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_SC_NA_1.fields_desc
...
class IEC104_IO_F_LS_NA_1_IOA(IEC104_IO_F_LS_NA_1):
    ...
    name = 'F_LS_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_LS_NA_1.fields_desc
...
class IEC104_IO_F_AF_NA_1_IOA(IEC104_IO_F_AF_NA_1):
    ...
    name = 'F_AF_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_AF_NA_1.fields_desc
...
class IEC104_IO_F_SG_NA_1_IOA(IEC104_IO_F_SG_NA_1):
    ...
    name = 'F_SG_NA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_SG_NA_1.fields_desc
...
class IEC104_IO_F_DR_TA_1_IOA(IEC104_IO_F_DR_TA_1):
    ...
    name = 'F_DR_TA_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_DR_TA_1.fields_desc
...
class IEC104_IO_F_SC_NB_1_IOA(IEC104_IO_F_SC_NB_1):
    ...
    name = 'F_SC_NB_1 (+ioa)'
    fields_desc = [LEThreeBytesField('information_object_address', 0)] + IEC104_IO_F_SC_NB_1.fields_desc

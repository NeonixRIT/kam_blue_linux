...
from scapy.fields import XShortField, ByteEnumField, XByteField, StrFixedLenField, StrLenField, LEShortField, LEFieldLenField, LEX3BytesField, XLEShortField
...
class PCOM(Packet):
    fields_desc = [XShortField('transId', RandShort()), ByteEnumField('mode', 0x65, _protocol_modes), XByteField('reserved', 0x00), LEShortField('len', None)]
...
class PCOMAsciiRequest(PCOMAscii):
    ...
    fields_desc = [StrFixedLenField('stx', '/', 1), StrFixedLenField('unitId', '00', 2), PCOMAsciiCommandField('command', '', length_from=lambda pkt: pkt.underlayer.len - 6), XShortField('chksum', None), XByteField('etx', 0x0D)]
...
class PCOMAsciiResponse(PCOMAscii):
    ...
    fields_desc = [StrFixedLenField('stx', '/A', 2), StrFixedLenField('unitId', '00', 2), PCOMAsciiCommandField('command', '', length_from=lambda pkt: pkt.underlayer.len - 7), XShortField('chksum', None), XByteField('etx', 0x0D)]

...
class PIDPacketBase(Packet):
    ...
    fields_desc = [
        ...
        EField(ShortField('parameterLength', 0), endianness=FORMAT_LE, endianness_from=None),
        StrLenField(
            'parameterData',
            '',
...
class PID_PLUGIN_PROMISCUITY_KIND(PIDPacketBase):
    ...
    fields_desc = [
        ...
        EField(ShortField('parameterLength', 0), endianness=FORMAT_LE, endianness_from=None),
        EField(XIntField('promiscuityKind', 0x0), endianness=FORMAT_LE, endianness_from=None),
    ]
...
class PID_RTI_DOMAIN_ID(PIDPacketBase):
    ...
    fields_desc = [
        ...
        EField(ShortField('parameterLength', 0), endianness=FORMAT_LE, endianness_from=None),
        EField(IntField('domainId', 0), endianness=FORMAT_LE, endianness_from=None),
    ]
...
class PID_TRANSPORT_INFO_LIST(PIDPacketBase):
    ...
    fields_desc = [
        ...
        EField(PacketListField('transportInfo', [], TransportInfoPacket, length_from=lambda p: p.parameterLength - 4)),
    ]
...
class PID_VENDOR_BUILTIN_ENDPOINT_SET(PIDPacketBase):
    ...
    fields_desc = [
        ...
        EField(ShortField('parameterLength', 0), endianness=FORMAT_LE, endianness_from=None),
        EField(XIntField('flags', 0), endianness=FORMAT_LE, endianness_from=None),
    ]

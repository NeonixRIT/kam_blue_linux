...
class IGMP(Packet):
    ...
    igmptypes = {0x11: 'Group Membership Query', 0x12: 'Version 1 - Membership Report', 0x16: 'Version 2 - Membership Report', 0x17: 'Leave Group'}

    fields_desc = [ByteEnumField('type', 0x11, igmptypes), ByteField('mrcode', 20), XShortField('chksum', None), IPField('gaddr', '0.0.0.0')]

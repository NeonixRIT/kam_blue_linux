...
HOST_PROTOCOL_CODES = {0x01: 'IPV4_UDP', 0x02: 'IPV4_TCP'}

# KNX Standard v2.1 - 03_08_02 p23
DESCRIPTION_TYPE_CODES = {0x01: 'DEVICE_INFO', 0x02: 'SUPP_SVC_FAMILIES', 0x03: 'IP_CONFIG', 0x04: 'IP_CUR_CONFIG', 0x05: 'KNX_ADDRESSES', 0x06: 'Reserved', 0xFE: 'MFR_DATA', 0xFF: 'not used'}

# KNX Standard v2.1 - 03_08_02 p30
CONNECTION_TYPE_CODES = {0x03: 'DEVICE_MANAGEMENT_CONNECTION', 0x04: 'TUNNEL_CONNECTION', 0x06: 'REMLOG_CONNECTION', 0x07: 'REMCONF_CONNECTION', 0x08: 'OBJSVR_CONNECTION'}

# KNX Standard v2.1 - 03_08_04
MESSAGE_CODES = {0x11: 'L_Data.req', 0x2E: 'L_Data.con', 0xFC: 'M_PropRead.req', 0xFB: 'M_PropRead.con', 0xF6: 'M_PropWrite.req', 0xF5: 'M_PropWrite.con'}

# KNX Standard v2.1 - 03_08_02 p24
KNX_MEDIUM_CODES = {0x01: 'reserved', 0x02: 'TP1', 0x04: 'PL110', 0x08: 'reserved', 0x10: 'RF', 0x20: 'KNX IP'}
...
class HPAI(Packet):
    name = 'HPAI'
    fields_desc = [ByteField('structure_length', None), ByteEnumField('host_protocol', 0x01, HOST_PROTOCOL_CODES), IPField('ip_address', None), ShortField('port', None)]
...
class TunnelingConnection(Packet):
    ...
    fields_desc = [ByteField('knx_layer', 0x02), ByteField('reserved', None)]
...
class CRI(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(PacketField('connection_data', TunnelingConnection(), TunnelingConnection), lambda pkt: pkt.connection_type == 0x04),
    ]
...
class CRD(Packet):
    ...
    fields_desc = [
        ...
        ByteEnumField('connection_type', 0x03, CONNECTION_TYPE_CODES),
        ConditionalField(PacketField('connection_data', CRDTunnelingConnection(), CRDTunnelingConnection), lambda pkt: pkt.connection_type == 0x04),
    ]
...
class LcEMI(Packet):
    ...
    fields_desc = [
        ...
        BitEnumField('broadcast_type', 1, 1, {1: 'domain'}),
...
class KNXConnectionstateResponse(Packet):
    ...
    fields_desc = [ByteField('communication_channel_id', None), ByteField('status', 0x00)]


# KNX Standard v2.1 - 03_08_02 p33
class KNXDisconnectRequest(Packet):
    name = 'DISCONNECT_REQUEST'
    fields_desc = [ByteField('communication_channel_id', 0x01), ByteField('reserved', None), PacketField('control_endpoint', HPAI(), HPAI)]
...
class KNXConfigurationRequest(Packet):
    ...
    fields_desc = [ByteField('structure_length', 0x04), ByteField('communication_channel_id', 0x01), ByteField('sequence_counter', None), ByteField('reserved', None), PacketField('cemi', CEMI(), CEMI)]
...
class KNXConfigurationACK(Packet):
    ...
    fields_desc = [ByteField('structure_length', None), ByteField('communication_channel_id', 0x01), ByteField('sequence_counter', None), ByteField('status', None)]
...
class KNX(Packet):
    name = 'KNXnet/IP'
    fields_desc = [ByteField('header_length', None), XByteField('protocol_version', 0x10), ShortEnumField('service_identifier', None, SERVICE_IDENTIFIER_CODES), ShortField('total_length', None)]

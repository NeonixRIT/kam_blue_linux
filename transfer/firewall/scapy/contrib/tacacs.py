...
TACACSPRIVLEVEL = {15: 'Root', 1: 'User', 0: 'Minimum'}

##########################
# Authentication Packets #
##########################

TACACSVERSION = {1: 'Tacacs', 192: 'Tacacs+'}

TACACSTYPE = {1: 'Authentication', 2: 'Authorization', 3: 'Accounting'}

TACACSFLAGS = {1: 'Unencrypted', 4: 'Single Connection'}

TACACSAUTHENACTION = {1: 'Login', 2: 'Change Pass', 4: 'Send Authentication'}
...
TACACSAUTHENSERVICE = {0: 'None', 1: 'Login', 2: 'Enable', 3: 'PPP', 4: 'ARAP', 5: 'PT', 6: 'RCMD', 7: 'X25', 8: 'NASI', 9: 'FwProxy'}

TACACSREPLYPASS = {1: 'PASS', 2: 'FAIL', 3: 'GETDATA', 4: 'GETUSER', 5: 'GETPASS', 6: 'RESTART', 7: 'ERROR', 21: 'FOLLOW'}
...
class TacacsAuthenticationStart(Packet):
    ...
    fields_desc = [
        ByteEnumField('action', 1, TACACSAUTHENACTION),
        ...
        ConditionalField(
            StrLenField('user', '', length_from=lambda x: x.user_len),  # noqa: E501
            lambda x: x != '',
        ),
...
class TacacsAuthenticationReply(Packet):
    ...
    fields_desc = [
        ByteEnumField('status', 1, TACACSREPLYPASS),
...
class TacacsAuthenticationContinue(Packet):
    ...
    fields_desc = [
        FieldLenField('user_msg_len', None, fmt='!H', length_of='user_msg'),  # noqa: E501
        FieldLenField('data_len', None, fmt='!H', length_of='data'),
...
TACACSAUTHORTYPE = {0: 'Not Set', 1: 'None', 2: 'Kerberos 5', 3: 'Line', 4: 'Enable', 5: 'Local', 6: 'Tacacs+', 8: 'Guest', 16: 'Radius', 17: 'Kerberos 4', 32: 'RCMD'}

TACACSAUTHORSTATUS = {1: 'Pass Add', 2: 'Pass repl', 16: 'Fail', 17: 'Error', 33: 'Follow'}
...
class TacacsAuthorizationRequest(Packet):
    ...
    fields_desc = [
        ...
        FieldListField('arg_len_list', [], ByteField('', 0), length_from=lambda pkt: pkt.arg_cnt),
...
TACACSACNTFLAGS = {2: 'Start', 4: 'Stop', 8: 'Watchdog'}
...
class TacacsAccountingRequest(Packet):
    ...
    fields_desc = [
        ByteEnumField('flags', 0, TACACSACNTFLAGS),
        ByteEnumField('authen_method', 0, TACACSAUTHORTYPE),
        ByteEnumField('priv_lvl', 1, TACACSPRIVLEVEL),
        ByteEnumField('authen_type', 1, TACACSAUTHENTYPE),
        ByteEnumField('authen_service', 1, TACACSAUTHENSERVICE),
...
class TacacsHeader(TacacsClientPacket):
    ...
    name = 'Tacacs Header'
    fields_desc = [ByteEnumField('version', 192, TACACSVERSION), ByteEnumField('type', 1, TACACSTYPE), ByteField('seq', 1), ByteEnumField('flags', 0, TACACSFLAGS), IntField('session_id', 0), IntField('length', None)]

...
from scapy.fields import BitField, ConditionalField, IntField, PacketField, XShortEnumField
...
if conf.crypto_valid:
    ...
    log_loading.info("Can't import python-cryptography v1.7+. " 'Disabled MACsec encryption/authentication.')
...
class MACsec(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(XShortEnumField('type', None, ETHER_TYPES), lambda pkt: 'type' in pkt.fields),
    ]

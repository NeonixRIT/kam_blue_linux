...
class EIGRPSeq(EIGRPGeneric):
    ...
    fields_desc = [
        ...
        ConditionalField(IP6Field('ip6addr', '2001::'), lambda pkt: pkt.addrlen == 16),
    ]
...
class EIGRPSwVer(EIGRPGeneric):
    ...
    fields_desc = [XShortField('type', 0x0004), ShortField('len', 8), ShortVersionField('ios', 'v12.0'), ShortVersionField('eigrp', 'v1.2')]


class EIGRPNms(EIGRPGeneric):
    name = 'EIGRP Next Multicast Sequence'
    fields_desc = [XShortField('type', 0x0005), ShortField('len', 8), IntField('nms', 2)]
...
class EIGRPStub(EIGRPGeneric):
    ...
    fields_desc = [XShortField('type', 0x0006), ShortField('len', 6), FlagsField('flags', 0x000D, 16, _EIGRP_STUB_FLAGS)]
...
_EIGRP_EXTERNAL_PROTOCOL_ID = {0x01: 'IGRP', 0x02: 'EIGRP', 0x03: 'Static Route', 0x04: 'RIP', 0x05: 'Hello', 0x06: 'OSPF', 0x07: 'IS-IS', 0x08: 'EGP', 0x09: 'BGP', 0x0A: 'IDRP', 0x0B: 'Connected Link'}

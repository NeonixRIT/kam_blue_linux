...
if sys.version_info >= (3, 7):
    ...
    def _unpickleNamedTuple(name, len_params, *args):
        return collections.namedtuple(name, args[:len_params])(*args[len_params:])
    ...
    def NamedTuple(name, params):
        ...
        class _NT(cls):
            def __reduce__(self):
                ...
                return (_unpickleNamedTuple, (name, len(tup_params)) + tup_params + tuple(self))

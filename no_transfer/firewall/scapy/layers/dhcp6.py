...
duidhwtypes = {
    0: 'NET/ROM pseudo',  # Not referenced by IANA
    1: 'Ethernet (10Mb)',
...
class DHCP6OptIAAddress(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.6
    ...
    fields_desc = [
        ShortEnumField('optcode', 5, dhcp6opts),
        FieldLenField('optlen', None, length_of='iaaddropts', fmt='!H', adjust=lambda pkt, x: x + 24),
        IP6Field('addr', '::'),
        ...
        PacketListField('iaaddropts', [], _DHCP6OptGuessPayloadElt, length_from=lambda pkt: pkt.optlen - 24),
    ]
...
class DHCP6OptIA_NA(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.4
    ...
    fields_desc = [
        ShortEnumField('optcode', 3, dhcp6opts),
        FieldLenField('optlen', None, length_of='ianaopts', fmt='!H', adjust=lambda pkt, x: x + 12),
        XIntField('iaid', None),
        IntField('T1', None),
        IntField('T2', None),
        PacketListField('ianaopts', [], _DHCP6OptGuessPayloadElt, length_from=lambda pkt: pkt.optlen - 12),
    ]
...
class DHCP6OptIA_TA(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.5
    ...
    fields_desc = [
        ShortEnumField('optcode', 4, dhcp6opts),
        FieldLenField('optlen', None, length_of='iataopts', fmt='!H', adjust=lambda pkt, x: x + 4),
        XIntField('iaid', None),
        PacketListField('iataopts', [], _DHCP6OptGuessPayloadElt, length_from=lambda pkt: pkt.optlen - 4),
    ]
...
class DHCP6OptOptReq(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.7
    ...
    fields_desc = [
        ShortEnumField('optcode', 6, dhcp6opts),
        FieldLenField('optlen', None, length_of='reqopts', fmt='!H'),  # noqa: E501
        _OptReqListField('reqopts', [23, 24], length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptAuth(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.11
    ...
    fields_desc = [
        ShortEnumField('optcode', 11, dhcp6opts),
        FieldLenField('optlen', None, length_of='authinfo', fmt='!H', adjust=lambda pkt, x: x + 11),
        ...
        StrLenField('authinfo', '', length_from=lambda pkt: pkt.optlen - 11),
    ]
...
class DHCP6OptStatusCode(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.13
    ...
    fields_desc = [
        ShortEnumField('optcode', 13, dhcp6opts),
        FieldLenField('optlen', None, length_of='statusmsg', fmt='!H', adjust=lambda pkt, x: x + 2),
        ShortEnumField('statuscode', None, dhcp6statuscodes),
        StrLenField('statusmsg', '', length_from=lambda pkt: pkt.optlen - 2),
    ]
...
class DHCP6OptVendorClass(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.16
    ...
    fields_desc = [
        ShortEnumField('optcode', 16, dhcp6opts),
        FieldLenField('optlen', None, length_of='vcdata', fmt='!H', adjust=lambda pkt, x: x + 4),
        IntEnumField('enterprisenum', None, IANA_ENTERPRISE_NUMBERS),
        _VendorClassDataField('vcdata', [], VENDOR_CLASS_DATA, length_from=lambda pkt: pkt.optlen - 4),
    ]  # noqa: E501
...
class DHCP6OptVendorSpecificInfo(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.17
    ...
    fields_desc = [
        ShortEnumField('optcode', 17, dhcp6opts),
        FieldLenField('optlen', None, length_of='vso', fmt='!H', adjust=lambda pkt, x: x + 4),
        IntEnumField('enterprisenum', None, IANA_ENTERPRISE_NUMBERS),
        _VendorClassDataField('vso', [], VENDOR_SPECIFIC_OPTION, length_from=lambda pkt: pkt.optlen - 4),
    ]  # noqa: E501
...
class DHCP6OptIAPrefix(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.22
    ...
    fields_desc = [
        ShortEnumField('optcode', 26, dhcp6opts),
        FieldLenField('optlen', None, length_of='iaprefopts', adjust=lambda pkt, x: x + 25),
        IntEnumField('preflft', 0, {0xFFFFFFFF: 'infinity'}),
        IntEnumField('validlft', 0, {0xFFFFFFFF: 'infinity'}),
        ...
        # expect failures
        PacketListField('iaprefopts', [], _DHCP6OptGuessPayloadElt, length_from=lambda pkt: pkt.optlen - 25),
    ]
...
class DHCP6OptIA_PD(_DHCP6OptGuessPayload):  # RFC 8415 sect 21.21
    ...
    fields_desc = [
        ShortEnumField('optcode', 25, dhcp6opts),
        FieldLenField('optlen', None, length_of='iapdopt', fmt='!H', adjust=lambda pkt, x: x + 12),
        XIntField('iaid', None),
        IntField('T1', None),
        IntField('T2', None),
        PacketListField('iapdopt', [], _DHCP6OptGuessPayloadElt, length_from=lambda pkt: pkt.optlen - 12),
    ]
...
class DHCP6OptInfoRefreshTime(_DHCP6OptGuessPayload):  # RFC4242
    ...
    fields_desc = [ShortEnumField('optcode', 32, dhcp6opts), ShortField('optlen', 4), IntField('reftime', IRT_DEFAULT)]  # One day
...
class DHCP6OptGeoConf(_DHCP6OptGuessPayload):  # RFC 4776
    ...
    fields_desc = [
        ShortEnumField('optcode', 36, dhcp6opts),
        FieldLenField('optlen', None, length_of='ca_elts', adjust=lambda x: x + 3),
        ByteEnumField('what', 2, _dhcp6_geoconf_what),
        StrFixedLenField('country_code', 'FR', 2),
        PacketListField('ca_elts', [], DHCP6OptGeoConfElement, length_from=lambda pkt: pkt.optlen - 3),
    ]
...
class DHCP6OptRemoteID(_DHCP6OptGuessPayload):  # RFC4649
    ...
    fields_desc = [
        ShortEnumField('optcode', 37, dhcp6opts),
        FieldLenField('optlen', None, length_of='remoteid', adjust=lambda pkt, x: x + 4),
        IntEnumField('enterprisenum', None, IANA_ENTERPRISE_NUMBERS),
        StrLenField('remoteid', '', length_from=lambda pkt: pkt.optlen - 4),
    ]
...
class DHCP6OptSubscriberID(_DHCP6OptGuessPayload):  # RFC4580
    ...
    fields_desc = [
        ShortEnumField('optcode', 38, dhcp6opts),
...
class DHCP6OptClientFQDN(_DHCP6OptGuessPayload):  # RFC4704
    ...
    fields_desc = [
        ShortEnumField('optcode', 39, dhcp6opts),
        FieldLenField('optlen', None, length_of='fqdn', adjust=lambda pkt, x: x + 1),
        BitField('res', 0, 5),
        FlagsField('flags', 0, 3, 'SON'),
        DNSStrField('fqdn', '', length_from=lambda pkt: pkt.optlen - 1),
    ]
...
class DHCP6OptVSS(_DHCP6OptGuessPayload):  # RFC6607
    ...
    fields_desc = [
        ShortEnumField('optcode', 68, dhcp6opts),
        FieldLenField('optlen', None, length_of='data', adjust=lambda pkt, x: x + 1),
        ByteField('type', 255),  # Default Global/default table
        StrLenField('data', '', length_from=lambda pkt: pkt.optlen),
    ]
...
class DHCP6OptClientLinkLayerAddr(_DHCP6OptGuessPayload):  # RFC6939
    ...
    fields_desc = [
        ShortEnumField('optcode', 79, dhcp6opts),
        FieldLenField('optlen', None, length_of='clladdr', adjust=lambda pkt, x: x + 2),
...
class DHCP6OptMudUrl(_DHCP6OptGuessPayload):  # RFC8520
    ...
    fields_desc = [
        ShortEnumField('optcode', 112, dhcp6opts),
...
class DHCP6(_DHCP6OptGuessPayload):
    ...
    fields_desc = [ByteEnumField('msgtype', None, dhcp6types), X3BytesField('trid', 0x000000)]
...
DHCPv6_am.parse_options( dns="2001:500::1035", domain="localdomain, local",
   ...
   If you have a need for others, just ask ... or provide a patch."""
    ...
    def parse_options(
        ...
        for o in [
            (dns, 'dns', 23, lambda x: DHCP6OptDNSServers(dnsservers=x)),

...
from scapy.fields import ByteEnumField, ShortEnumField, FieldLenField, StrLenField
...
class TLSPlaintext(Packet):
    name = 'TLS Plaintext'
    fields_desc = [ByteEnumField('type', None, _tls_type), ShortEnumField('version', None, _tls_version), FieldLenField('len', None, length_of='data', fmt='!H'), StrLenField('data', '', length_from=lambda pkt: pkt.len)]

...
from scapy.fields import ByteEnumField, ByteField, EnumField, FieldLenField, ShortEnumField, StrLenField, XStrField, XStrLenField
...
from scapy.layers.tls.crypto.suites import _tls_cipher_suites, _tls_cipher_suites_cls, get_usable_ciphersuites, SSL_CK_DES_192_EDE3_CBC_WITH_MD5
...
_sslv2_handshake_type = {0: 'error', 1: 'client_hello', 2: 'client_master_key', 3: 'client_finished', 4: 'server_hello', 5: 'server_verify', 6: 'server_finished', 7: 'request_certificate', 8: 'client_certificate'}
...
_tls_error_code = {1: 'no_cipher', 2: 'no_certificate', 4: 'bad_certificate', 6: 'unsupported_certificate_type'}
...
class SSLv2Error(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 0, _sslv2_handshake_type), ShortEnumField('code', None, _tls_error_code)]
...
class SSLv2ClientHello(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField('msgtype', 1, _sslv2_handshake_type),
        _TLSVersionField('version', 0x0002, _tls_version),
        FieldLenField('cipherslen', None, fmt='!H', length_of='ciphers'),
        FieldLenField('sidlen', None, fmt='!H', length_of='sid'),
        FieldLenField('challengelen', None, fmt='!H', length_of='challenge'),
        XStrLenField('sid', b'', length_from=lambda pkt: pkt.sidlen),
        _SSLv2CipherSuitesField('ciphers', [SSL_CK_DES_192_EDE3_CBC_WITH_MD5], _tls_cipher_suites, length_from=lambda pkt: pkt.cipherslen),  # noqa: E501
        XStrLenField('challenge', b'', length_from=lambda pkt: pkt.challengelen),
    ]
...
class SSLv2ServerHello(_SSLv2Handshake):
    ...
    fields_desc = [
        ...
        _TLSVersionField('version', 0x0002, _tls_version),
        FieldLenField('certlen', None, fmt='!H', length_of='cert'),
        FieldLenField('cipherslen', None, fmt='!H', length_of='ciphers'),
        FieldLenField('connection_idlen', None, fmt='!H', length_of='connection_id'),
        _SSLv2CertDataField('cert', b'', length_from=lambda pkt: pkt.certlen),
        _SSLv2CipherSuitesField('ciphers', [], _tls_cipher_suites, length_from=lambda pkt: pkt.cipherslen),  # noqa: E501
        XStrLenField('connection_id', b'', length_from=lambda pkt: pkt.connection_idlen),
    ]
...
class SSLv2ClientMasterKey(_SSLv2Handshake):
    ...
    fields_desc = [
        ...
        FieldLenField('encryptedkeylen', None, fmt='!H', length_of='encryptedkey'),
        FieldLenField('keyarglen', None, fmt='!H', length_of='keyarg'),
        XStrLenField('clearkey', '', length_from=lambda pkt: pkt.clearkeylen),
        _SSLv2EncryptedKeyField('encryptedkey', '', length_from=lambda pkt: pkt.encryptedkeylen),  # noqa: E501
...
class SSLv2ServerVerify(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 5, _sslv2_handshake_type), XStrField('challenge', '')]
...
class SSLv2RequestCertificate(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 7, _sslv2_handshake_type), ByteEnumField('authtype', 1, {1: 'md5_with_rsa'}), XStrField('challenge', '')]
...
class SSLv2ClientCertificate(_SSLv2Handshake):
    ...
    fields_desc = [
        ByteEnumField('msgtype', 8, _sslv2_handshake_type),
        ByteEnumField('certtype', 1, {1: 'x509_cert'}),
        FieldLenField('certlen', None, fmt='!H', length_of='certdata'),
        FieldLenField('responselen', None, fmt='!H', length_of='responsedata'),
        _SSLv2CertDataField('certdata', b'', length_from=lambda pkt: pkt.certlen),
        _TLSSignatureField('responsedata', None, length_from=lambda pkt: pkt.responselen),
    ]
...
class SSLv2ClientFinished(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 3, _sslv2_handshake_type), XStrField('connection_id', '')]
...
class SSLv2ServerFinished(_SSLv2Handshake):
    ...
    fields_desc = [ByteEnumField('msgtype', 6, _sslv2_handshake_type), XStrField('sid', '')]
...
_sslv2_handshake_cls = {0: SSLv2Error, 1: SSLv2ClientHello, 2: SSLv2ClientMasterKey, 3: SSLv2ClientFinished, 4: SSLv2ServerHello, 5: SSLv2ServerVerify, 6: SSLv2ServerFinished, 7: SSLv2RequestCertificate, 8: SSLv2ClientCertificate}

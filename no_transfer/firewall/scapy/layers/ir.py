...
from scapy.fields import BitEnumField, ByteEnumField, StrField, XBitField, XByteField, XIntField, XShortField
...
class IrLAPHead(Packet):
    ...
    fields_desc = [XBitField('Address', 0x7F, 7), BitEnumField('Type', 1, 1, {'Response': 0, 'Command': 1})]
...
class IrLMP(Packet):
    ...
    fields_desc = [XShortField('Service_hints', 0), XByteField('Character_set', 0), StrField('Device_name', '')]

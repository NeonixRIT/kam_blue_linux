...
from scapy.asn1fields import ASN1F_INTEGER, ASN1F_IPADDRESS, ASN1F_OID, ASN1F_SEQUENCE, ASN1F_SEQUENCE_OF, ASN1F_STRING, ASN1F_TIME_TICKS, ASN1F_enum_INTEGER, ASN1F_field, ASN1F_CHOICE
from scapy.asn1.asn1 import ASN1_Class_UNIVERSAL, ASN1_Codecs, ASN1_NULL, ASN1_SEQUENCE
...
class SNMPvarbind(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(ASN1F_OID('oid', '1.3'), ASN1F_field('value', ASN1_NULL(0)))


class SNMPget(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SNMP_PDU_GET(
        ASN1F_INTEGER('id', 0),
...
class SNMPresponse(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SNMP_PDU_RESPONSE(
        ASN1F_INTEGER('id', 0),
...
class SNMPtrapv1(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SNMP_PDU_TRAPv1(
...
class SNMPinform(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SNMP_PDU_INFORM(
        ASN1F_INTEGER('id', 0),
        ASN1F_enum_INTEGER('error', 0, SNMP_error),  # noqa: E501
        ASN1F_INTEGER('error_index', 0),
        ASN1F_SEQUENCE_OF('varbindlist', [], SNMPvarbind),  # noqa: E501
...
class SNMPtrapv2(ASN1_Packet):
    ASN1_codec = ASN1_Codecs.BER
    ASN1_root = ASN1F_SNMP_PDU_TRAPv2(
        ASN1F_INTEGER('id', 0),
        ASN1F_enum_INTEGER('error', 0, SNMP_error),  # noqa: E501
        ASN1F_INTEGER('error_index', 0),
        ASN1F_SEQUENCE_OF('varbindlist', [], SNMPvarbind),  # noqa: E501
...
class SNMP(ASN1_Packet):
    ...
    ASN1_root = ASN1F_SEQUENCE(
        ...
        ASN1F_CHOICE('PDU', SNMPget(), SNMPget, SNMPnext, SNMPresponse, SNMPset, SNMPtrapv1, SNMPbulk, SNMPinform, SNMPtrapv2),
    )

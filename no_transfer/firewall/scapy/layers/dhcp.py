...
DHCPOptions = {
    ...
    55: _DHCPParamReqFieldListField('param_req_list', [], ByteField('opcode', 0)),
    56: 'error_message',
    ...
    121: ClasslessFieldListField('classless_static_routes', [], ClasslessStaticRoutesField('route', 0)),
    124: 'vendor_class',
...
class BOOTP_am(AnsweringMachine):
    ...
    def parse_options(self, pool=Net('192.168.1.128/25'), network='192.168.1.0/24', gw='192.168.1.1', nameserver=None, domain='localnet', renewal_time=60, lease_time=1800):
        """

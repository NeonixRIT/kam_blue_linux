...
from scapy.data import ARPHDR_ETHER, ARPHDR_LOOPBACK, ARPHDR_PPP, ARPHDR_TUN, IPV6_ADDR_GLOBAL
...
if LINUX:
    ...
    log_loading.critical('Scapy currently does not support %s! I/O will NOT work!' % sys.platform)
    SIOCGIFHWADDR = 0  # mypy compat

...
class RandString(_RandString[bytes]):
    _DEFAULT_CHARS = (string.ascii_uppercase + string.ascii_lowercase + string.digits).encode('utf-8')
...
class RandUUID(RandField[uuid.UUID]):
    ...
    _REG = re.compile(r'^{0}-?{1}-?{1}-?{2}{2}-?{2}{2}{2}{2}{2}{2}$'.format(_BASE.format(8), _BASE.format(4), _BASE.format(2)), re.I)
    VERSIONS = [1, 3, 4, 5]

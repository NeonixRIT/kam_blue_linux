...
class ParticipantMessageDataPacket(EPacket):
    ...
    fields_desc = [
        ...
        XIntField('kind', 0),
        EField(XIntField('sequenceSize', 0), endianness_from=e_flags),  # octets
        StrLenField(
            'serializedData',
            '',
...
class DataPacket(EPacket):
    ...
    fields_desc = [
        ...
        ConditionalField(
            ...
            lambda pkt: (pkt.encapsulationKind != 0x0003 and pkt._pl_type != 'ParticipantMessageData'),
        ),
    ]
...
class RTPSSubMessage_DATA(EPacket):
    ...
    fields_desc = [
        ...
        EField(ShortField('octetsToNextHeader', 0), endianness_from=e_flags),
        XNBytesField('extraFlags', 0x0000, 2),
        EField(ShortField('octetsToInlineQoS', 0), endianness_from=e_flags),
        ...
        EField(IntField('writerSeqNumLow', 0), endianness_from=e_flags),
        # -------------------------------------
        ConditionalField(
        ...
        ConditionalField(
            DataPacketField('key', '', DataPacket, endianness_from=e_flags),
            lambda pkt: pkt.submessageFlags & 0b00001000 == 0b00001000,
        ),
        ConditionalField(
            DataPacketField('data', '', DataPacket, endianness_from=e_flags),
...
class RTPSSubMessage_ACKNACK(EPacket):
    ...
    fields_desc = [
        ...
        XStrLenField('readerSNState', 0, length_from=lambda pkt: pkt.octetsToNextHeader - 8 - 4),
...
class RTPSSubMessage_HEARTBEAT(EPacket):
    ...
    fields_desc = [
        ...
        EField(IntField('count', 0), endianness_from=e_flags),
    ]

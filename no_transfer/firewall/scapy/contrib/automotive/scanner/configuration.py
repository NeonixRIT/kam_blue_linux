...
class AutomotiveTestCaseExecutorConfiguration(object):
    ...
    def _generate_test_case_config(self, test_case_cls):
        ...
        self.__setattr__(test_case_cls.__name__, self.global_kwargs.pop(kwargs_name, dict()))
    ...
    def add_test_case(self, test_case):
        ...
        if inspect.isclass(test_case):
            test_case_class = cast(Union[Type[AutomotiveTestCaseABC], Type[StagedAutomotiveTestCase]], test_case)
            if issubclass(test_case_class, StagedAutomotiveTestCase):
                ...
                raise TypeError('Provided class is not in ' 'Union[Type[AutomotiveTestCaseABC], ' 'Type[StagedAutomotiveTestCase]]')
            ...
            raise TypeError('Provided instance or class of ' 'StagedAutomotiveTestCase or AutomotiveTestCaseABC')

...
from scapy.fields import ByteEnumField, StrField, ConditionalField, BitField, XByteField, X3BytesField, ByteField, ObservableDict, XShortEnumField, XByteEnumField
...
class KWP_SDS(Packet):
    diagnosticSessionTypes = ObservableDict({0x81: 'defaultSession', 0x85: 'programmingSession', 0x89: 'standBySession', 0x90: 'EcuPassiveSession', 0x92: 'extendedDiagnosticSession'})
...
class KWP_SDSPR(Packet):
    ...
    fields_desc = [
        ByteEnumField('diagnosticSession', 0, KWP_SDS.diagnosticSessionTypes),
    ]
...
# ######################### KWP_ER ###################################
class KWP_ER(Packet):
    resetModes = {0x00: 'reserved', 0x01: 'powerOnReset', 0x82: 'nonvolatileMemoryReset'}
    name = 'ECUReset'
...
class KWP_SAPR(Packet):
    ...
    fields_desc = [
        ...
        ConditionalField(StrField('seed', b''), lambda pkt: pkt.accessMode % 2 == 1),
    ]
...
class KWP_IOCBLI(Packet):
    ...
    inputOutputControlParameters = {0x00: 'Return Control to ECU', 0x01: 'Report Current State', 0x04: 'Reset to Default', 0x05: 'Freeze Current State', 0x07: 'Short Term Adjustment', 0x08: 'Long Term Adjustment'}
...
class KWP_CDTCS(Packet):
    ...
    DTCGroups = {0x0000: 'allPowertrainDTCs', 0x4000: 'allChassisDTCs', 0x8000: 'allBodyDTCs', 0xC000: 'allNetworkDTCs', 0xFF00: 'allDTCs'}
...
class KWP_ROE(Packet):
    ...
    eventWindowTimes = {0x00: 'reserved', 0x01: 'testerPresentRequired', 0x02: 'infiniteTimeToResponse', 0x80: 'noEventWindow'}
    eventTypes = {0x80: 'reportActivatedEvents', 0x81: 'stopResponseOnEvent', 0x82: 'onNewDTC', 0x83: 'onTimerInterrupt', 0x84: 'onChangeOfRecordValue', 0xA0: 'onComparisonOfValues'}
...
class KWP_DDLI(Packet):
    ...
    definitionModes = {0x1: 'defineByLocalIdentifier', 0x2: 'defineByMemoryAddress', 0x3: 'defineByIdentifier', 0x4: 'clearDynamicallyDefinedLocalIdentifier'}
...
class KWP_DDLIPR(Packet):
    ...
    def answers(self, other):
        # type: (Packet) -> int
        return isinstance(other, KWP_DDLI) and other.dynamicallyDefineLocalIdentifier == self.dynamicallyDefineLocalIdentifier  # noqa: E501
...
class KWP_NR(Packet):
    ...
    fields_desc = [XByteEnumField('requestServiceId', 0, KWP.services), ByteEnumField('negativeResponseCode', 0, negativeResponseCodes)]

    def answers(self, other):
        # type: (Packet) -> int
        return self.requestServiceId == other.service and (self.negativeResponseCode != 0x78 or conf.contribs['KWP']['treat-response-pending-as-answer'])

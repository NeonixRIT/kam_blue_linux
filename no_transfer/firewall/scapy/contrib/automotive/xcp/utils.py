...
def get_ag():
    ...
    if address_granularity and address_granularity in [1, 2, 4]:
        ...
        log_automotive.warning("Define conf.contribs['XCP']['Address_Granularity_Byte']." 'Assign either 1, 2 or 4')
        return 1
...
def identification_field_needs_alignment():
    try:
        identification_field_type_0 = conf.contribs['XCP']['identification_field_type_0']
        identification_field_type_1 = conf.contribs['XCP']['identification_field_type_1']

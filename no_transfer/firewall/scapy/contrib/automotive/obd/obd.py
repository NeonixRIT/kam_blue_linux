...
try:
    ...
    log_automotive.info(
        "Specify \"conf.contribs['OBD'] = " "{'treat-response-pending-as-answer': True}\" to treat " "a negative response 'requestCorrectlyReceived-" "ResponsePending' as answer of a request. \n" 'The default value is False.'
    )

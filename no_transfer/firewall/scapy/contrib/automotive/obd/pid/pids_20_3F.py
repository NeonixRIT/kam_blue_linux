...
class OBD_PID21(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0, unit='km', fmt='H')]


class OBD_PID22(OBD_Packet):
    name = 'PID_22_FuelRailPressure'
    fields_desc = [ScalingField('data', 0, scaling=0.079, unit='kPa', fmt='H')]
...
class _OBD_PID24_2B(OBD_Packet):
    fields_desc = [ScalingField('equivalence_ratio', 0, scaling=0.0000305, fmt='H'), ScalingField('voltage', 0, scaling=0.000122, unit='V', fmt='H')]
...
class OBD_PID30(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0)]
...
class OBD_PID32(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0, scaling=0.25, unit='Pa', fmt='h')]
...
class _OBD_PID34_3B(OBD_Packet):
    fields_desc = [ScalingField('equivalence_ratio', 0, scaling=0.0000305, fmt='H'), ScalingField('current', 0, scaling=0.00390625, unit='mA', fmt='H')]
...
class OBD_PID3C(OBD_Packet):
    ...
    fields_desc = [ScalingField('data', 0, scaling=0.1, unit='deg. C', offset=-40.0, fmt='H')]

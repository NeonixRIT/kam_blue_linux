...
class GeneveOptions(Packet):
    name = 'Geneve Options'
    fields_desc = [XShortEnumField('classid', 0x0000, CLASS_IDS), XByteField('type', 0x00), BitField('reserved', 0, 3), BitField('length', None, 5), StrLenField('data', '', length_from=lambda x: x.length * 4)]

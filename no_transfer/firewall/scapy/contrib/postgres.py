...
class Startup(Packet):
    ...
    fields_desc = [
        FieldLenField('len', None, length_of='options', fmt='I', adjust=lambda pkt, x: x + 8),
...
class SignedIntStrPair(_ZeroPadding):
    ...
    fields_desc = [
        ...
        StrLenField('data', None, length_from=lambda pkt: pkt.len if pkt.len > 0 else 0),
    ]
...
class Query(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'Q'),
        FieldLenField('len', None, length_of='query', fmt='I', adjust=lambda pkt, x: x + 5),
...
class RowDescription(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'T'),
        FieldLenField('len', None, fmt='I', length_of='cols', adjust=lambda pkt, x: x + 6),
...
class DataRow(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'D'),
        FieldLenField('len', None, fmt='I', length_of='data', adjust=lambda pkt, x: len(pkt) - 1),
...
class ErrorResponse(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'E'),
        FieldLenField('len', None, length_of='error_fields', fmt='I', adjust=lambda pkt, x: x + 5),
        FieldListField(
            'error_fields',
            [],
...
class Bind(_ZeroPadding):
    ...
    fields_desc = [
        ...
        PacketListField('values', [], SignedIntStrPair, count_from=lambda pkt: pkt.values_count),
...
class Close(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'C'),
        FieldLenField('len', None, fmt='I', length_of='statement', adjust=lambda pkt, x: x + 6),
...
class Execute(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'E'),
        FieldLenField('len', None, fmt='I', length_of='portal', adjust=lambda pkt, x: x + 9),
        StrNullField(
            'portal',
            '',
        ),
...
class NoticeResponse(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'N'),
        FieldLenField('len', None, length_of='notice_fields', fmt='I', adjust=lambda pkt, x: x + 5),
        FieldListField(
            'notice_fields',
            [],
            ErrorResponseField('value', None),
...
class NegotiateProtocolVersion(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'v'),
        FieldLenField('len', None, fmt='I', length_of='option', adjust=lambda pkt, x: x + 12),
...
class FunctionCallResponse(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'V'),
        FieldLenField('len', None, fmt='I', length_of='result', adjust=lambda pkt, x: x + 8),
...
class ParameterDescription(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b't'),
        FieldLenField('len', None, fmt='I', length_of='dtypes', adjust=lambda pkt, x: x + 6),
...
class CopyInResponse(_ZeroPadding):
    ...
    fields_desc = [
        ByteTagField(b'G'),
        FieldLenField('len', None, fmt='I', length_of='cols', adjust=lambda pkt, x: x + 7),
        ByteField('format', 0),
        ShortField('ncols', 0),
        FieldListField(
            'cols',

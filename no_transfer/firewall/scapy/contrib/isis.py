...
class _ISIS_GenericTlv_Base(Packet):
    fields_desc = [ByteField('type', 0), FieldLenField('len', None, length_of='val', fmt='B'), BoundStrLenField('val', '', length_from=lambda pkt: pkt.len)]  # noqa: E501
...
class ISIS_IPv4InterfaceAddressSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [ByteEnumField('type', 6, _isis_subtlv_names_1), FieldLenField('len', None, length_of='address', fmt='B'), IPField('address', '0.0.0.0')]


class ISIS_IPv4NeighborAddressSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS IPv4 Neighbor Address (S)'
    fields_desc = [ByteEnumField('type', 8, _isis_subtlv_names_1), FieldLenField('len', None, length_of='address', fmt='B'), IPField('address', '0.0.0.0')]


class ISIS_LinkLocalRemoteIdentifiersSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS Link Local/Remote Identifiers (S)'
    fields_desc = [ByteEnumField('type', 4, _isis_subtlv_names_1), FieldLenField('len', 8, fmt='B'), IntField('localid', '0'), IntField('remoteid', '0')]


class ISIS_IPv6InterfaceAddressSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS IPv6 Interface Address (S)'
    fields_desc = [ByteEnumField('type', 12, _isis_subtlv_names_1), FieldLenField('len', None, length_of='address', fmt='B'), IP6Field('address', '::')]


class ISIS_IPv6NeighborAddressSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS IPv6 Neighbor Address (S)'
    fields_desc = [ByteEnumField('type', 13, _isis_subtlv_names_1), FieldLenField('len', None, length_of='address', fmt='B'), IP6Field('address', '::')]


class ISIS_AdministrativeGroupSubTlv(ISIS_GenericSubTlv):
    name = 'Administrative Group SubTLV (Color)'
    fields_desc = [ByteEnumField('code', 3, _isis_subtlv_names_1), FieldLenField('len', None, length_of='admingroup', fmt='B'), IPField('admingroup', '0.0.0.1')]


class ISIS_MaximumLinkBandwidthSubTlv(ISIS_GenericSubTlv):
    name = 'Maximum Link Bandwidth SubTLV'
    fields_desc = [ByteEnumField('type', 9, _isis_subtlv_names_1), FieldLenField('len', None, length_of='maxbw', fmt='B'), IEEEFloatField('maxbw', 1000)]  # in B/s


class ISIS_MaximumReservableLinkBandwidthSubTlv(ISIS_GenericSubTlv):
    name = 'Maximum Reservable Link Bandwidth SubTLV'
    fields_desc = [ByteEnumField('type', 10, _isis_subtlv_names_1), FieldLenField('len', None, length_of='maxrsvbw', fmt='B'), IEEEFloatField('maxrsvbw', 1000)]  # in B/s


class ISIS_UnreservedBandwidthSubTlv(ISIS_GenericSubTlv):
    name = 'Unreserved Bandwidth SubTLV'
    fields_desc = [
        ByteEnumField('type', 11, _isis_subtlv_names_1),
...
class ISIS_TEDefaultMetricSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ByteEnumField('type', 18, _isis_subtlv_names_1),
...
#######################################################################
_isis_subtlv_classes_2 = {1: 'ISIS_32bitAdministrativeTagSubTlv', 2: 'ISIS_64bitAdministrativeTagSubTlv', 3: 'ISIS_PrefixSegmentIdentifierSubTlv'}

_isis_subtlv_names_2 = {1: '32-bit Administrative Tag', 2: '64-bit Administrative Tag', 3: 'Prefix Segment Identifier'}
...
class ISIS_32bitAdministrativeTagSubTlv(ISIS_GenericSubTlv):
    ...
    fields_desc = [ByteEnumField('type', 1, _isis_subtlv_names_2), FieldLenField('len', None, length_of='tags', fmt='B'), FieldListField('tags', [], IntField('', 0), count_from=lambda pkt: pkt.len // 4)]  # noqa: E501


class ISIS_64bitAdministrativeTagSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS 64-bit Administrative Tag (S)'
    fields_desc = [ByteEnumField('type', 2, _isis_subtlv_names_2), FieldLenField('len', None, length_of='tags', fmt='B'), FieldListField('tags', [], LongField('', 0), count_from=lambda pkt: pkt.len // 8)]  # noqa: E501


class ISIS_PrefixSegmentIdentifierSubTlv(ISIS_GenericSubTlv):
    name = 'ISIS Prefix SID sub TLV'
    fields_desc = [
        ByteEnumField('type', 3, _isis_subtlv_names_2),
        ByteField('len', 5),
        FlagsField('flags', 0, 8, ['res1', 'res2', 'L', 'V', 'E', 'P', 'N', 'R']),
        ByteField('algorithm', 0),
        ConditionalField(ThreeBytesField('sid', 0), lambda pkt: pkt.len == 5),
        ConditionalField(IntField('idx', 0), lambda pkt: pkt.len == 6),
    ]
...
#######################################################################
_isis_subtlv_classes_3 = {1: 'ISIS_SIDLabelSubTLV'}

_isis_subtlv_names_3 = {1: 'ISIS SID/Label sub TLV'}
...
class ISIS_SIDLabelSubTLV(ISIS_GenericSubTlv):
    ...
    fields_desc = [ByteEnumField('type', 1, _isis_subtlv_names_3), ByteField('len', 3), ConditionalField(ThreeBytesField('sid', 0), lambda pkt: pkt.len == 3), ConditionalField(IntField('idx', 0), lambda pkt: pkt.len == 4)]
...
class ISIS_SRGBDescriptorEntry(Packet):
    ...
    fields_desc = [ThreeBytesField('range', 0), PacketField('sid_label', None, ISIS_SIDLabelSubTLV)]
...
class ISIS_SRCapabilitiesSubTLV(ISIS_GenericSubTlv):
    ...
    fields_desc = [
        ...
        FieldLenField('len', None, length_of='srgb_ranges', adjust=lambda pkt, x: x + 1, fmt='B'),
        FlagsField('flags', 0, 8, ['res1', 'res2', 'res3', 'res4', 'res5', 'res6', 'V', 'I']),
        PacketListField('srgb_ranges', [], ISIS_SRGBDescriptorEntry, length_from=lambda pkt: pkt.len - 1),
    ]


class ISIS_SRAlgorithmSubTLV(ISIS_GenericSubTlv):
    name = 'ISIS SR Algorithm sub TLV'
    fields_desc = [ByteEnumField('type', 19, _isis_subtlv_names_4), FieldLenField('len', None, length_of='algorithms', fmt='B'), FieldListField('algorithms', [0], ByteField('', 0), count_from=lambda pkt: pkt.len)]
...
class ISIS_AreaEntry(Packet):
    ...
    fields_desc = [FieldLenField('arealen', None, length_of='areaid', fmt='B'), ISIS_AreaIdField('areaid', '49', length_from=lambda pkt: pkt.arealen)]  # noqa: E501
...
class ISIS_AreaTlv(ISIS_GenericTlv):
    name = 'ISIS Area TLV'
    fields_desc = [ByteEnumField('type', 1, _isis_tlv_names), FieldLenField('len', None, length_of='areas', fmt='B'), PacketListField('areas', [], ISIS_AreaEntry, length_from=lambda x: x.len)]  # noqa: E501
...
class ISIS_BufferSizeTlv(ISIS_GenericTlv):
    ...
    fields_desc = [ByteEnumField('type', 14, _isis_tlv_names), ByteField('len', 2), ShortField('lspbuffersize', 1497)]


class ISIS_ChecksumTlv(ISIS_GenericTlv):
    name = 'ISIS Optional Checksum TLV'
    fields_desc = [ByteEnumField('type', 12, _isis_tlv_names), ByteField('len', 2), XShortField('checksum', None)]


class ISIS_DynamicHostnameTlv(ISIS_GenericTlv):
    name = 'ISIS Dynamic Hostname TLV'
    fields_desc = [ByteEnumField('type', 137, _isis_tlv_names), FieldLenField('len', None, length_of='hostname', fmt='B'), BoundStrLenField('hostname', '', length_from=lambda pkt: pkt.len)]  # noqa: E501
...
class ISIS_TERouterIDTlv(ISIS_GenericTlv):
    ...
    fields_desc = [ByteEnumField('type', 134, _isis_tlv_names), FieldLenField('len', None, length_of='routerid', fmt='B'), IPField('routerid', '0.0.0.0')]


class ISIS_ExtendedIpReachabilityTlv(ISIS_GenericTlv):
    name = 'ISIS Extended IP Reachability TLV'
    fields_desc = [ByteEnumField('type', 135, _isis_tlv_names), FieldLenField('len', None, length_of='pfxs', fmt='B'), PacketListField('pfxs', [], ISIS_ExtendedIpPrefix, length_from=lambda pkt: pkt.len)]  # noqa: E501
...
class ISIS_ExtendedIsReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [ByteEnumField('type', 22, _isis_tlv_names), FieldLenField('len', None, length_of='neighbours', fmt='B'), PacketListField('neighbours', [], ISIS_ExtendedIsNeighbourEntry, length_from=lambda x: x.len)]  # noqa: E501


class ISIS_IpInterfaceAddressTlv(ISIS_GenericTlv):
    name = 'ISIS IP Interface Address TLV'
    fields_desc = [ByteEnumField('type', 132, _isis_tlv_names), FieldLenField('len', None, length_of='addresses', fmt='B'), FieldListField('addresses', [], IPField('', '0.0.0.0'), count_from=lambda pkt: pkt.len // 4)]  # noqa: E501


class ISIS_Ipv6InterfaceAddressTlv(ISIS_GenericTlv):
    name = 'ISIS IPv6 Interface Address TLV'
    fields_desc = [ByteEnumField('type', 232, _isis_tlv_names), FieldLenField('len', None, length_of='addresses', fmt='B'), IP6ListField('addresses', [], count_from=lambda pkt: pkt.len // 16)]
...
class ISIS_Ipv6ReachabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [ByteEnumField('type', 236, _isis_tlv_names), FieldLenField('len', None, length_of='pfxs', fmt='B'), PacketListField('pfxs', [], ISIS_Ipv6Prefix, length_from=lambda pkt: pkt.len)]  # noqa: E501


class ISIS_IsNeighbourTlv(ISIS_GenericTlv):
    name = 'ISIS IS Neighbour TLV'
    fields_desc = [ByteEnumField('type', 6, _isis_tlv_names), FieldLenField('len', None, length_of='neighbours', fmt='B'), FieldListField('neighbours', [], MACField('', '00.00.00.00.00.00'), count_from=lambda pkt: pkt.len // 6)]  # noqa: E501


class ISIS_LspEntry(Packet):
    name = 'ISIS LSP Entry'
    fields_desc = [ShortField('lifetime', 1200), ISIS_LspIdField('lspid', '0102.0304.0506.07-08'), XIntField('seqnum', 0x00000001), XShortField('checksum', None)]
...
class ISIS_P2PAdjacencyStateTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ByteEnumField('type', 240, _isis_tlv_names),
...
class ISIS_PaddingTlv(ISIS_GenericTlv):
    ...
    fields_desc = [ByteEnumField('type', 8, _isis_tlv_names), FieldLenField('len', None, length_of='padding', fmt='B'), BoundStrLenField('padding', '', length_from=lambda pkt: pkt.len)]
...
class ISIS_RouterCapabilityTlv(ISIS_GenericTlv):
    ...
    fields_desc = [
        ...
        FieldLenField('len', None, length_of='subtlvs', adjust=lambda pkt, x: x + 5, fmt='B'),
        IPField('routerid', '0.0.0.0'),
        FlagsField('flags', 0, 8, ['S', 'D', 'res1', 'res2', 'res3', 'res4', 'res5', 'res6']),
        PacketListField('subtlvs', [], _ISIS_GuessSubTlvClass_4, length_from=lambda pkt: pkt.len - 5),
    ]
...
class ISIS_IpReachabilityEntry(Packet):
    ...
    fields_desc = [ByteField('defmetric', 1), ByteField('delmetric', 0x80), ByteField('expmetric', 0x80), ByteField('errmetric', 0x80), IPField('ipaddress', '0.0.0.0'), IPField('subnetmask', '255.255.255.255')]
...
class ISIS_IsReachabilityEntry(Packet):
    ...
    fields_desc = [ByteField('defmetric', 1), ByteField('delmetric', 0x80), ByteField('expmetric', 0x80), ByteField('errmetric', 0x80), ISIS_NodeIdField('neighbourid', '0102.0304.0506.07')]
...
#   ISIS PDU Packets                                                  #
#######################################################################
_isis_pdu_names = {15: 'L1 LAN Hello', 16: 'L2 LAN Hello', 17: 'P2P Hello', 18: 'L1 LSP', 20: 'L2 LSP', 24: 'L1 CSNP', 25: 'L2 CSNP', 26: 'L1 PSNP', 27: 'L2 PSNP'}
...
class ISIS_P2P_Hello(_ISIS_PduBase):
    ...
    fields_desc = [ISIS_CircuitTypeField(), ISIS_SystemIdField('sourceid', '0102.0304.0506'), ShortField('holdingtime', 30), _ISIS_PduLengthField(), ByteField('localcircuitid', 0), _ISIS_TlvListField()]
...
class _ISIS_CSNP_Base(_ISIS_PduBase):
    fields_desc = [_ISIS_PduLengthField(), ISIS_NodeIdField('sourceid', '0102.0304.0506.00'), ISIS_LspIdField('startlspid', '0000.0000.0000.00-00'), ISIS_LspIdField('endlspid', 'FFFF.FFFF.FFFF.FF-FF'), _ISIS_TlvListField()]
...
class _ISIS_PSNP_Base(_ISIS_PduBase):
    fields_desc = [_ISIS_PduLengthField(), ISIS_NodeIdField('sourceid', '0102.0304.0506.00'), _ISIS_TlvListField()]

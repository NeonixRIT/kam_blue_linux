...
from scapy.fields import BitField, IPField, IntField, ShortField, StrField, XBitField
...
class LDPNotification(_LDP_Packet):
    ...
    fields_desc = [BitField('u', 0, 1), BitField('type', 0x0001, 15), ShortField('len', None), IntField('id', 0), StatusTLVField('status', (0, 0, 0, 0, 0))]
...
class LDPHello(_LDP_Packet):
    name = 'LDPHello'
    fields_desc = [BitField('u', 0, 1), BitField('type', 0x0100, 15), ShortField('len', None), IntField('id', 0), CommonHelloTLVField('params', [180, 0, 0])]
...
class LDPInit(_LDP_Packet):
    name = 'LDPInit'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0200, 15), ShortField('len', None), IntField('id', 0), CommonSessionTLVField('params', None)]
...
class LDPKeepAlive(_LDP_Packet):
    name = 'LDPKeepAlive'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0201, 15), ShortField('len', None), IntField('id', 0)]
...
class LDPAddress(_LDP_Packet):
    name = 'LDPAddress'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0300, 15), ShortField('len', None), IntField('id', 0), AddressTLVField('address', None)]
...
class LDPAddressWM(_LDP_Packet):
    name = 'LDPAddressWM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0301, 15), ShortField('len', None), IntField('id', 0), AddressTLVField('address', None)]
...
class LDPLabelMM(_LDP_Packet):
    name = 'LDPLabelMM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0400, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), LabelTLVField('label', 0)]
...
class LDPLabelReqM(_LDP_Packet):
    name = 'LDPLabelReqM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0401, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None)]
...
class LDPLabelARM(_LDP_Packet):
    name = 'LDPLabelARM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0404, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), IntField('labelRMid', 0)]
...
class LDPLabelWM(_LDP_Packet):
    name = 'LDPLabelWM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0402, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), LabelTLVField('label', 0)]
...
class LDPLabelRelM(_LDP_Packet):
    name = 'LDPLabelRelM'
    fields_desc = [BitField('u', 0, 1), XBitField('type', 0x0403, 15), ShortField('len', None), IntField('id', 0), FecTLVField('fec', None), LabelTLVField('label', 0)]
...
class LDP(_LDP_Packet):
    name = 'LDP'
    fields_desc = [ShortField('version', 1), ShortField('len', None), IPField('id', '127.0.0.1'), ShortField('space', 0)]

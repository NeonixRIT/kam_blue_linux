...
class RIPng(Packet):
    name = 'RIPng header'
    fields_desc = [ByteEnumField('cmd', 1, {1: 'req', 2: 'resp'}), ByteField('ver', 1), ShortField('null', 0)]


class RIPngEntry(Packet):
    name = 'RIPng entry'
    fields_desc = [IP6Field('prefix_or_nh', '::'), ShortField('routetag', 0), ByteField('prefixlen', 0), ByteEnumField('metric', 1, {16: 'Unreach', 255: 'next-hop entry'})]

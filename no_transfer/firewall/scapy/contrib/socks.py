...
from scapy.fields import ByteField, ByteEnumField, ShortField, IPField, StrField, MultipleTypeField
...
class SOCKS(Packet):
    fields_desc = [
        ByteEnumField('vn', 0x5, {0x4: 'v4 - Request', 0x0: 'v4 - Reply', 0x5: 'v5'}),
    ]
...
_socks4_cd_reply = {90: 'Request granted', 91: 'Request rejected', 92: 'Request rejected - SOCKS server cannot connect to identd', 93: 'Request rejected - user-ids mismatch'}
...
class SOCKS5Request(Packet):
    ...
    fields_desc = [
        ...
        ByteField('res', 0),
        ByteEnumField('atyp', 0x1, {0x1: 'IPv4', 0x3: 'DomainName', 0x4: 'IPv6'}),
        MultipleTypeField(
            [
                # IPv4

...
skinny_ring_type = {0x1: 'Ring off'}

skinny_speaker_modes = {0x1: 'Speaker on', 0x2: 'Speaker off'}
...
class SkinnyMessageSetRinger(Packet):
    name = 'Ring message'
    fields_desc = [LEIntEnumField('ring', 0x1, skinny_ring_type), LEIntField('unknown1', 0), LEIntField('unknown2', 0), LEIntField('unknown3', 0)]


_skinny_tones = {0x21: 'Inside dial tone', 0x22: 'xxx', 0x23: 'xxx', 0x24: 'Alerting tone', 0x25: 'Reorder Tone'}


class SkinnyMessageStartTone(Packet):
    name = 'Start tone'
    fields_desc = [LEIntEnumField('tone', 0x21, _skinny_tones), LEIntField('unknown1', 0), LEIntField('instance', 1), LEIntField('callid', 0)]
...
class SkinnyMessageSetLamp(Packet):
    ...
    fields_desc = [LEIntEnumField('stimulus', 0x5, skinny_stimulus), LEIntField('instance', 1), LEIntEnumField('mode', 2, skinny_lamp_mode)]


class SkinnyMessageStationSelectSoftKeysMessage(Packet):
    name = 'Station Select Soft Keys Message'
    fields_desc = [LEIntField('instance', 1), LEIntField('callid', 0), LEIntField('set', 0), LEIntField('map', 0xFFFF)]


class SkinnyMessagePromptStatus(Packet):
    name = 'Prompt status'
    fields_desc = [LEIntField('timeout', 0), StrFixedLenField('text', b'\0' * 32, 32), LEIntField('instance', 1), LEIntField('callid', 0)]
...
_skinny_codecs = {0x0: 'xxx', 0x1: 'xxx', 0x2: 'xxx', 0x3: 'xxx', 0x4: 'G711 ulaw 64k'}

_skinny_echo = {0x0: 'echo cancellation off', 0x1: 'echo cancellation on'}
...
_skinny_receive_channel_status = {0x0: 'ok', 0x1: 'ko'}

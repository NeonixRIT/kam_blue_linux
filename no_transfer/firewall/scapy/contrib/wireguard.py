...
class Wireguard(Packet):
    ...
    fields_desc = [ByteEnumField('message_type', 1, {1: 'initiate', 2: 'respond', 3: 'cookie reply', 4: 'transport'}), ThreeBytesField('reserved_zero', 0)]
...
class WireguardTransport(Packet):
    ...
    fields_desc = [XLEIntField('receiver_index', 0), XLELongField('counter', 0), XStrField('encrypted_encapsulated_packet', None)]

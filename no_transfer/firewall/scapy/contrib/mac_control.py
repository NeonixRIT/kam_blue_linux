...
class MACControlPause(MACControl):
    ...
    def get_pause_time(self, speed=ETHER_SPEED_MBIT_1000):
        ...
        try:
            return self.pause_time * {ETHER_SPEED_MBIT_10: (0.0000001 * 512), ETHER_SPEED_MBIT_100: (0.00000001 * 512), ETHER_SPEED_MBIT_1000: (0.000000001 * 512 * 2)}[speed]
        except KeyError:
            raise MACControlInvalidSpeedException(
                'Invalid speed selector given. '  # noqa: E501

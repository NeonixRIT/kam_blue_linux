...
rsvpmsgtypes = {0x01: 'Path', 0x02: 'Reservation request', 0x03: 'Path error', 0x04: 'Reservation request error', 0x05: 'Path teardown', 0x06: 'Reservation teardown', 0x07: 'Reservation request acknowledgment'}


class RSVP(Packet):
    name = 'RSVP'
    fields_desc = [BitField('Version', 1, 4), BitField('Flags', 1, 4), ByteEnumField('Class', 0x01, rsvpmsgtypes), XShortField('chksum', None), ByteField('TTL', 1), XByteField('dataofs', 0), ShortField('Length', None)]
...
class RSVP_Object(Packet):
    name = 'RSVP_Object'
    fields_desc = [ShortField('Length', 4), ByteEnumField('Class', 0x01, rsvptypes), ByteField('C_Type', 1)]

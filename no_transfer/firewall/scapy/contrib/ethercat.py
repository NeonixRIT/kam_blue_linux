...
from scapy.fields import BitField, ByteField, LEShortField, FieldListField, LEIntField, FieldLenField, _EnumField, EnumField
    ...
    def _check_field_type(self, pkt, index):
        ...
        try:
            ...
            if type(next_field) is not LEBitField and next_field.__class__.__base__ is not LEBitField:
                raise LEBitFieldSequenceException('field after field {} must ' 'be of type LEBitField or ' 'derived classes'.format(self.name))  # noqa: E501
        except IndexError:
...
ETHERCAT_TYPE_12_CIRCULATING_FRAME = {0x00: 'FRAME-NOT-CIRCULATING', 0x01: 'FRAME-CIRCULATED-ONCE'}

ETHERCAT_TYPE_12_NEXT_FRAME = {0x00: 'LAST-TYPE12-PDU', 0x01: 'TYPE12-PDU-FOLLOWS'}
...
class EtherCatType12DLPDU(Packet):
    ...
    PHYSICAL_ADDRESSING_DESC = [
        ...
        LEShortField('irq', 0),
        FieldListField('data', [], ByteField('', 0x00), count_from=lambda pkt: pkt.len),
        LEShortField('wkc', 0),
    ]
...
class EtherCatAPRD(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x01)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPRD(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x04)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatBRD(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x07)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLRD(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x0A)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatAPWR(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x02)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPWR(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x05)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatBWR(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x08)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLWR(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x0B)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatAPRW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x03)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFPRW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x06)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatBRW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x09)] + EtherCatType12DLPDU.BROADCAST_ADDRESSING_DESC
...
class EtherCatLRW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x0C)] + EtherCatType12DLPDU.LOGICAL_ADDRESSING_DESC
...
class EtherCatARMW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x0D)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCatFRMW(EtherCatType12DLPDU):
    ...
    fields_desc = [ByteField('_cmd', 0x0E)] + EtherCatType12DLPDU.PHYSICAL_ADDRESSING_DESC
...
class EtherCat(Packet):
    ...
    FRAME_TYPES = {0x01: 'TYPE-12-PDU', 0x04: 'NETWORK-VARIABLES', 0x05: 'MAILBOX'}

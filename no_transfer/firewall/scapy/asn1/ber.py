...
class BERcodec_Object(Generic[_K]):
    ...
    def dec(
        ...
        try:
            ...
            o, remain = BERcodec_Object.dec(e.remaining, context, safe)  # type: Tuple[ASN1_Object[Any], bytes]
...
class BERcodec_SEQUENCE(BERcodec_Object[Union[bytes, List[BERcodec_Object[Any]]]]):  # noqa: E501
    ...
    def do_dec(
        ...
        while s:
            try:
                o, remain = BERcodec_Object.dec(s, context, safe)  # type: Tuple[ASN1_Object[Any], bytes]
                s = remain
